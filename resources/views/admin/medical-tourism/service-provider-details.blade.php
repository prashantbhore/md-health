...
<section class="main-content">
    <div class="container2 pb-5">
        <div class="d-flex align-items-center justify-content-between">
            <div class="page-title">Medical Service Provider ID #273929 <small> Reg Date : 26 Jan 2023 11:45am </small></div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 mb-3 mt-5">
                                <p class="card-title mb-3">Reviews</p>
                                <div class="d-flex align-items-center gap-2">
                                    <div>
                                        <img src="{{URL::asset('admin/assets/img/starVector.png')}}" alt="" />
                                    </div>
                                    <p class="reviews-count mb-0"><span>4.4</span> (12 Reviews)</p>
                                </div>
