...
<section class="main-content">
    <div class="container2 pb-5">
        <div class="d-flex align-items-center justify-content-between">
            <div class="page-title">Food Suplier ID #273929</div>
            <a href="{{URL::asset('admin/food-suppliers')}}" class="page-title"> <img src="{{URL::asset('admin/assets/img/ArrowLeftCircle.png')}}" alt="" class="back-btn" /> Back Food Suppliers </a>
        </div>
        <div class="row top-cards">
            <div class="col-md-6">
                <div class="card card-details mb-3" style="min-height: 380px;">
                    <div class="card-body">
                        <p class="card-title mb-3">Food Suplier Details</p>
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="row">
                                    <div class="col-md-6 d-flex flex-column ">
                                        ...
                                        <div>
                                            <img src="{{URL::asset('admin/assets/img/bk.png')}}" alt="" />
                                        </div>
                            ...
                            <div class="col-md-12 mb-3">
                                <div class="d-flex align-content-end justify-content-end gap-3">
                                    <button type="submit" class="btn md-btn save-btn">Confirm Suplier</button>
                                    <button type="submit" class="btn md-btn delete-btn">Reject Suplier</button>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card card-details" style="min-height: 776px;">
                    <div class="card-body">
                        <div class="mb-3 d-flex align-items-center justify-content-between w-full filters">
                            <p class="card-title">Food History</p>
