            ...
            <div class="col mb-3">
                <div class="card bg-green position-relative">
                    <div class="card-body">
                        <div class="d-flex align-items-center gap-2">
                            <div class="card-text d-flex flex-column">
                                <p class="text-black">MDbooking</p>
                                <h4>3</h4>
                            </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="w-full d-flex align-items-center justify-content-end gap-2 mb-3 filters">
                                   <div class="card-title me-auto">MDbooking Categories</div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-0">
                ...
                <div class="modal-body px-4">
                    <h4 class="mb-4 md-fw-bold">Add New Category for MD<span class="fw-light">booking</span></h4>
                    ...
                    <form>
                        ...
                        <div class="mb-3 treatmentsAdd">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control border-end-0" placeholder="Subcategory" aria-label="Subcategory" aria-describedby="addTreatment">
