        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-0">
                ...
                <div class="modal-body px-4">
                    <h4 class="mb-4 md-fw-bold">Add New Category for MD<span class="fw-light">shop</span></h4>
                    
                    <form action="{{route('category.mdshop.store')}}" method="post">
                        @csrf
...
@endsection
@section('script')
<script src="{{url('admin\controller_js\admin_cn_product_md_shop.js')}}"></script>
<script>
