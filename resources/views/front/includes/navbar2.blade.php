        ...
        <div class="collapse navbar-collapse justify-content-end ms-5 w-100" id="navbarNavDropdown">
            <ul class="navbar-nav align-items-center gap-5 w-100">
                ...
                <li class="nav-item dropdown ms-auto" style="margin-right: -24px;">
                    <a href="{{ url('user-notifications') }}" class="nav-link">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle text-white" href="#" id="navbarDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false"> Welcome <span class="text-green me-1 ms-2">
                    ...
                    @elseif(Session::get('MDFoodVendor*%') != null)
                    <ul class="dropdown-menu animate slideIn" aria-labelledby="navbarDropdownMenuLink">
                        <li>
                            <a class="dropdown-item" href="{{ url('/medical-provider-dashboard') }}">
                                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 12 12" fill="none">
