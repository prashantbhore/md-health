...
<nav class="navbar fixed-top navbar-expand-lg navbar-light md-navbar py-3" style="background-color: black;">
    <div class="container">
        ...
        <div class="collapse navbar-collapse justify-content-center" id="navbarNavDropdown">
                        ...
                        <ul class="dropdown-menu animate slideIn" aria-labelledby="navbarDropdownMenuLink">
                                ...
                                <a class="dropdown-item" href="{{ url('my-packages-list') }}">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14"
                                        ...
                                        <g clip-path="url(#clip0_321_962)">
                                            <path
                                                d="M12.1975 5.15665L4.99337 1.30082C4.83079 1.21451 4.64953 1.16937 4.46546 1.16937C4.28138 1.16937 4.10012 1.21451 3.93754 1.30082L1.80837 2.40915C1.6164 2.51436 1.45579 2.66864 1.34295 2.85623C1.23011 3.04382 1.1691 3.258 1.16613 3.4769C1.16316 3.69579 1.21836 3.91155 1.32607 4.10213C1.43378 4.29271 1.59015 4.45129 1.77921 4.56165L8.90754 8.60415C9.08067 8.70017 9.2754 8.75055 9.47337 8.75055C9.67135 8.75055 9.86607 8.70017 10.0392 8.60415L12.25 7.29749C12.4352 7.18434 12.5873 7.02446 12.6912 6.83391C12.795 6.64337 12.8468 6.42885 12.8415 6.21192C12.8362 5.99499 12.7739 5.78328 12.6608 5.59805C12.5478 5.41281 12.388 5.26059 12.1975 5.15665Z"
                                                stroke="#111111" stroke-width="1.16667" stroke-linecap="round"
                                                stroke-linejoin="round" />
                                            <path
                                                d="M7.00005 12.8333V7.58332M1.80255 5.15665L9.00671 1.30082C9.16929 1.21451 9.35056 1.16937 9.53463 1.16937C9.7187 1.16937 9.89997 1.21451 10.0625 1.30082L12.1917 2.40915C12.3852 2.5117 12.5481 2.6638 12.6635 2.84991C12.779 3.03602 12.843 3.24945 12.8489 3.46838C12.8548 3.68732 12.8025 3.9039 12.6973 4.09599C12.5921 4.28808 12.4377 4.44877 12.25 4.56165L5.09255 8.60415C4.91941 8.70017 4.72469 8.75055 4.52671 8.75055C4.32874 8.75055 4.13401 8.70017 3.96088 8.60415L1.75005 7.29749C1.56488 7.18434 1.41275 7.02446 1.30893 6.83391C1.20511 6.64337 1.15326 6.42885 1.15857 6.21192C1.16389 5.99499 1.2262 5.78328 1.33924 5.59805C1.45227 5.41281 1.61206 5.26059 1.80255 5.15665Z"
                                                stroke="#111111" stroke-width="1.16667" stroke-linecap="round"
                                                stroke-linejoin="round" />
                                            <path
                                ...
                                <a class="dropdown-item" href="#">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14"
                                        ...
                                        <path
                                            ...
                                            stroke="#111111" stroke-width="0.875" />
                                    </svg>
                                    Messages
                                </a>
                            </li>
                            ...
                            <li>
                                <a class="dropdown-item" href="#">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14"
                                        viewBox="0 0 12 12" fill="none">
                                        <path d="M3 4H5" stroke="#111111" stroke-width="0.625" stroke-linecap="round"
                                            stroke-linejoin="round" />
                                        <path
                                            d="M10.4165 4.5H9.1155C8.223 4.5 7.5 5.1715 7.5 6C7.5 6.8285 8.2235 7.5 9.115 7.5H10.4165C10.4585 7.5 10.479 7.5 10.4965 7.499C10.7665 7.4825 10.9815 7.283 10.999 7.0325C11 7.0165 11 6.997 11 6.9585V5.0415C11 5.003 11 4.9835 10.999 4.9675C10.981 4.717 10.7665 4.5175 10.4965 4.501C10.4795 4.5 10.4585 4.5 10.4165 4.5Z"
                                            stroke="#111111" stroke-width="0.625" />
                                        <path
                                            d="M10.4825 4.5C10.4435 3.564 10.3185 2.99 9.914 2.586C9.3285 2 8.3855 2 6.5 2H5C3.1145 2 2.1715 2 1.586 2.586C1 3.1715 1 4.1145 1 6C1 7.8855 1 8.8285 1.586 9.414C2.1715 10 3.1145 10 5 10H6.5C8.3855 10 9.3285 10 9.914 9.414C10.3185 9.01 10.444 8.436 10.4825 7.5"
                                            stroke="#111111" stroke-width="0.625" />
                                        <path d="M8.99548 6H8.99965" stroke="#111111" stroke-width="0.833333"
                                            stroke-linecap="round" stroke-linejoin="round" />
                                    </svg>
                                    Wallet
                                </a>
                            ...
                            <li>
                                <a class="dropdown-item" href="#">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14"
                                        viewBox="0 0 14 14" fill="none">
                                        <path
                                            d="M7.58337 4.25002H10.7917L7.58337 1.04169V4.25002ZM3.50004 0.166687H8.16671L11.6667 3.66669V10.6667C11.6667 10.9761 11.5438 11.2729 11.325 11.4916C11.1062 11.7104 10.8095 11.8334 10.5 11.8334H3.50004C3.19062 11.8334 2.89388 11.7104 2.67508 11.4916C2.45629 11.2729 2.33337 10.9761 2.33337 10.6667V1.33335C2.33337 0.685854 2.85254 0.166687 3.50004 0.166687ZM4.08337 10.6667H5.25004V7.16669H4.08337V10.6667ZM6.41671 10.6667H7.58337V6.00002H6.41671V10.6667ZM8.75004 10.6667H9.91671V8.33335H8.75004V10.6667Z"
                                            fill="#111111" />
                                    </svg>
                                    Reports
                                </a>
            ...
            <!-- Menu for Medical Service Provider -->
            <!--@if (Session::get('MDMedicalProvider*%') != null)
-->
