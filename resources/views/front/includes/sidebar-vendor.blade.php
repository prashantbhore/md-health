    ...
    <div class="card-body">
        <ul class="nav flex-column nav-stuff">
            <li class="nav-item mpDashboardLi">
                <a class="nav-link mpDashboard" aria-current="page" href="{{url('vendor-dashboard')}}">Dashboard</a>
            </li>
            <li class="nav-item mpSalesLi">
                <a class="nav-link mpSales" href="{{url('vendor-sales')}}">Sales</a>
            </li>
            <li class="nav-item mpProductsLi">
                <a class="nav-link mpProducts" href="{{url('vendor-products')}}">Products</a>
            </li>
            <li class="nav-item">
