...
<nav id="mdHealth" class="navbar navbar-expand-lg navbar-light md-navbar py-4" style="background-color: black;">
    <div class="container p-0">
        ...
        <div class="collapse navbar-collapse justify-content-end align-items-center me-auto w-100" style="margin-left: 65px;" id="navbarNavDropdown">
            <ul class="navbar-nav align-items-center gap-5 me-auto w-100">
                <li class="nav-item"><a href="{{ url('home-service') }}" class="nav-link">Home Service</a></li>
                <li class="nav-item"><a href="{{ url('md-booking-home-page') }}" class="nav-link"><span class="camptonBold">MD</span>Booking</a></li>
                <li class="nav-item"><a href="{{ url('mdFoods') }}" class="nav-link"><span class="camptonBold">MD</span>Foods</a></li>
                <li class="nav-item"><a href="{{ url('mdShop') }}" class="nav-link"><span class="camptonBold">MD</span>Shop</a></li>
                ...
                <li class="nav-item dropdown ms-auto">
                    <a class="nav-link dropdown-toggle text-white" href="#" id="navbarDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false"> Welcome
                        <span class="text-green ms-2 me-1">{{ $name }}</span> <svg xmlns="http://www.w3.org/2000/svg" width="13" height="8" viewBox="0 0 13 8" fill="none">
                    ...
                    <ul class="dropdown-menu animate slideIn" aria-labelledby="navbarDropdownMenuLink">
                        ...
                        <li>
                            <a class="dropdown-item" href="{{ url('user-reservation') }}">
                        ...
                        <li>
                            <a class="dropdown-item" href="{{ url('user-message') }}">
                                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" fill="none">
                        ...
                        <li>
                            <a class="dropdown-item" href="{{ url('user-all-reports') }}">
                                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" fill="none">
                        ...
                        <li>
                            <a class="dropdown-item" href="{{ url('user-favorites') }}">
        ...
        <div class="nav-login">
            @if (Session::get('login_token') == null)
            <a href="{{ url('sign-in-web') }}" class="nav-link underline text-white text-decoration-underline w-50">Sign In</a>
