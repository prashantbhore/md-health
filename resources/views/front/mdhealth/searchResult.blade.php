    ...
    <div class="container">
        <div class="d-flex gap-3">
            ...
            <div class="w-761">
                                ...
                                <div>
                                    ...
                                    <div class="my-2">
                                        ...
                                        <p class="mb-3 card-h4">
                                            ...
                                            <span class="lira">₺</span> <span class="card-h1">*{{ '(' . get_twenty_percent(!empty($package_list['sale_price']) ? $package_list['sale_price'] : 0) . ' ₺)' }}
                                            </span>
                                        </p>
                    ...
                    <div class="modal-dialog modal-dialog-centered position-relative">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="d-flex align-items-center flex-column">
                                ...
                                <a href="{{ url('#') }}" data-bs-dismiss="modal" data-bs-toggle="modal" id="{{ $package_list['id'] }}" data-bs-target="#treatmentForModal2" type="button" class="btn btn-sm whiteBtn df-center mt-3 mb-5 other_btn">Other</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <!-- Start Other Model -->
                <div class="modal fade treatmentForModal2" id="treatmentForModal2" tabindex="-1" aria-labelledby="treatmentForModal2" aria-hidden="true">
