                                ...
                                @foreach ($treatment_plans as $treatment_plan)
                                    @if ($treatment_plan->product_category_name == $treatment_name)
                                        <option value="{{ $treatment_plan->product_category_name }}" selected>
                                            {{ $treatment_plan->product_category_name }}</option>
                                    @else
                            ...
                            <div class="packageResult rounded mb-3">
                                <div>
                                    ...
                                    <div class="d-flex gap-5 mb-4">
                                        ...
                                        <div class="d-flex align-items-center gap-1">
                                            ...
                                            <p class="mb-0 lctn fst-italic">
                                                {{ $packages[$key]['treatment_period_in_days'] }}</p>
                                        </div>
                                    </div>
                                    <div class="d-flex gap-4">
                                                    ...
                                                    @if (!empty($package_list['other_services'][$key]))
                                                        <div class="d-flex gap-1 align-items-baseline mb-1">
                                                            ...
                                                            <p class="mb-0 camptonBook smallFont">
                                                                {{ $package_list['other_services'][$key] }}</p>
                                                        </div>
                                                    @endif
                                        ...
                                        <div class="brdr-right">
                                            <p class="mb-0"><span class="text-green fw-bold camptonBold"
                                                    style="font-size: 1.125rem;">Reviews</span><span
                                        ...
                                        <div class="d-flex flex-column align-items-end gap-4">
                                            <div>
                                                <p class="mb-0">
                                                    <span class="text-green fw-bold camptonBold"
                                                        style="font-size: 1.125rem;">Package Price</span>
                                                </p>
                                                <div class="my-2">
                                                    <p class="mb-0 fs-5 camptonBold lh-base">
                                                        {{ $package_list['package_price'] }} ₺ <span
                                                            class="smallFont fs-6">*{{ '(' . get_twenty_percent($package_list['package_price']) . '₺)' }}</span>
                                                    </p>
