            ...
            <div class="container mt-5">
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    <li class="nav-item" role="presentation">
                        ...
                        <div id="home-tab" data-bs-toggle="tab" data-bs-target="#home" class="nav-link   d-flex justify-content-center align-items-center main-mid-seaction">
                    ...
                    <li class="nav-item" role="presentation">
                        <div id="contact-tab" data-bs-toggle="tab" data-bs-target="#contact" class="nav-link active  d-flex justify-content-center align-items-center main-mid-seaction">
                ...
                <div class="tab-content main-mid-seaction-h1 rounded  " id="myTabContent">
                    ...
                    <div class="tab-pane fade show active vehical-tab-div" id="contact" role="tabpanel" aria-labelledby="contact-tab">
                        <div class="md-booking-serach-filter p-3 mb-2 bg-white">
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="d-flex flex-column justify-content-center align-items-start h-100 border booking-box-h">
