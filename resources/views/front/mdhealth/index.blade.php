                ...
                <div class="modal-body">
                    <form class="row g-3">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="tel" class="form-control " id="inputAddress33"
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" class="form-control " id="inputAddress443"
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <textarea name="" id="" cols="" style="height: 66px;" class="form-control"
                        ...
                        <div class="col-md-6 mb-3 position-relative">
                            ...
                            <div class="form-control position-relative" style="height:101px">
                                <textarea name="" id="" class="form-control border-0 p-0" id="pre-treat" style="resize:none;"
                        ...
                        <div class="col-md-6 mb-4">
                            ...
                            <input type="text" class="form-control " id="inputAddress5"
                                placeholder="Write in week or month">
                        </div>
                        <div class="col-md-6 mb-4">
