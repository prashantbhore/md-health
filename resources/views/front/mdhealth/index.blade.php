...
@section('content')
    ...
    <div class="bg-f6">
                        ...
                        <form method="POST" action="{{ url('health-search-result') }}" class="w-100">
                            ...
                            <div class="search-bar d-flex align-items-center p-3">
                                ...
                                <div class="form-floating pe-3 position-relative">
                                    <img src="{{ 'front/assets/img/Icon-treatment.png' }}" alt=""
                                        class="mx-2 pill-calender">
                                    <input type="hidden" name="platform_type" value="web">
                                    <select class="form-select" style="padding-left:35px" name="treatment_name"
                                ...
                                <div class="form-floating pe-3 position-relative">
                                    <input type="text" class="form-select bod-n-3"
                                        style="background-image: none;padding-left:32px" name="daterange" value="" />
        ...
        <div class="py-100px pb-0 md-coin df-center flex-column gap-5 bg-f6 section-3 mb-5">
            ...
            <p class="mb-5 camptonBook text-center fs-18" style="font-weight: 400;">Earn <span
                    class="camptonBold">cashback</span> per transaction or <span class="camptonBold">invite your
        ...
        <div class="container download-section d-flex justify-content-around">
            ...
            <div class="part2 section-2">
                <div class="mb-4">
                    ...
                    <h2 class="my-0"><span class="camptonBold text-green">MD</span><span
                            class="text-green camptonBook">health</span> <span class="camptonBold">Mobile</span></h2>
    ...
    <div class="bg-black position-relative section6">
        <div class="container medical-pckg">
            <p class="mb-0">Find your <span class="text-green">medical</span> package <span
            ...
            <div class="modal-content p-3">
                <div>
                    ...
                    <div class="text-center" style="margin-top: -8px;">
                        <h4 class="modal-title mb-2" id="exampleModalLabel">Couldn't find your <span
                                class="green-color">treatment</span> package?</h4>
                        <p class="mb-4">Fill the form & get your desired treatment plan</p>
                    </div>
                </div>
                <div class="modal-body">
                    <form id="request_your_treatment" method="POST" action="{{ url('request-your-treatment') }}"
                        class="row g-3" enctype="multipart/form-data">
                        <div class="col-md-4 mb-3">
                            <label for="inputEmail4" class="form-label fw-bold">*First Name</label>
                            <input type="text" class="form-control "name="first_name" id="inputAddress443"
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="tel" class="form-control "name="contact_no" id="inputAddress33"
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" class="form-control "name="treatment_name" id="inputAddress443"
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <textarea name="details" id="" cols="" style="height: 66px;" class="form-control"
                                id="inputAddress5" placeholder="Please write your treatment requirement in detail"></textarea>
                        </div>
                        <div class="col-md-6 mb-3 position-relative">
                            ...
                            <div class="form-control position-relative" style="height:101px">
                                <textarea name="previous_treatment" class="form-control border-0 p-0" id="pre-treat" style="resize:none;"
                                    placeholder="Have you done / received any releted treatment before"></textarea>
                        ...
                        <div class="col-md-6 mb-4">
                            <label for="inputAddress5" class="form-label fw-bold">*When do you need the
                                treatment?</label>
                            <input type="text" class="form-control " name="why_do_you_need_treatment"
                                id="inputAddress5" placeholder="Write in week or month">
                        </div>
                        <div class="col-md-6 mb-4">
