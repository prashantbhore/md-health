                            ...
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="user-completed-tab" data-bs-toggle="tab"
                                        data-bs-target="#user-completed" type="button" role="tab" aria-controls="user-completed"
                                        aria-selected="false">Completed</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="user-cancelled-tab" data-bs-toggle="tab"
                                        data-bs-target="#user-cancelled" type="button" role="tab" aria-controls="user-cancelled"
                                    ...
                                    <div class="treatment-card-div mb-3">
                                        <div class="treatment-card df-start w-100 mb-3">
                                            <div class="row card-row">
                                                ...
                                                <div class="col-md-2 d-flex flex-column justify-content-between align-items-end text-end">
                                                    <div class="trmt-card-footer">
                                                        <a href="{{url('')}}" class="d-flex align-items-center gap-1 text-gray fsb-1">
                                        ...
                                        <div class="treatment-card df-start w-100 mb-3">
                                            <div class="row card-row">
                                                ...
                                                <div class="col-md-6 justify-content-start ps-0">
                                                    <div class="trmt-card-body">
                                                        <h5 class="dashboard-card-title fw-600 mb-0">Acıbadem Hospital</h5>
                                                        <h6 class="mb-1 fsb-1">Heart Valve Replacement Surgery</h6>
                                                        <div class="trmt-card-location d-flex align-items-center gap-2 mb-3">
                                                            <p class="fsb-2 mb-0 d-flex align-items-center gap-1">
                                                                <svg width="10" height="15" viewBox="0 0 10 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        ...
                                                        <h6 class="mb-1 fsb-1">Time left to treatment: <span class="text-green">Completed!</span></h6>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row card-row">
                                                ...
                                                <div class="col-md-10 justify-content-start ps-0">
                                                    <div class="trmt-card-body">
                                                        ...
                                                        <h6 class="mb-1 fsb-1">Time left to treatment: <span class="text-red">Cancelled</span></h6>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
