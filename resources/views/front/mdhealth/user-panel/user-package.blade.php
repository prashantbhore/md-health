                        ...
                        <div class="tab-div user-package-tab">
                            ...
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link active" id="user-tab" data-bs-toggle="tab" data-bs-target="#user" type="button" role="tab" aria-controls="user" aria-selected="true">Active</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="user-completed-tab" data-bs-toggle="tab" data-bs-target="#user-completed" type="button" role="tab" aria-controls="user-completed" aria-selected="false">Completed</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="user-cancelled-tab" data-bs-toggle="tab" data-bs-target="#user-cancelled" type="button" role="tab" aria-controls="user-cancelled" aria-selected="false">Cancelled</button>
                                </li>
                            </ul>
                            ...
                            <div class="tab-content " id="myTabContent">
                                <div class="tab-pane fade show active" id="user" role="tabpanel" aria-labelledby="user-tab">
                                    ...
                                    <div class="card shadow-none mb-3 pkgCard">
                                        <div class="card-body d-flex gap-3 w-100 p-3">
                                            <div class="df-center">
                                                <img src="{{ asset($active_package['company_logo_image_path']) }}" alt="" class="md-img">
                                            ...
                                            <div class="ms-auto pkgMsg">
                                                <a href="javascript:;" class="d-flex align-items-center gap-1 md-gray">
                                    ...
                                    <div class="treatment-card-btns d-flex justify-content-around gap-3">
                                        <a href="{{ url('view-my-active-packages/' . $active_package['package_id'] . '/' . $active_package['purchase_id']) }}" id="package-details_{{ $active_package['package_id'] }}" class="order-completed-btn w-100 bg-white text-black fsb-2 border border-black package-details">Package
                                            Details</a>
                                        <a href="javascript:void(0)" class="order-completed-btn camThin w-100 bg-black text-white UserChangeInformation" id="change_information_model-{{ $active_package['package_id'] . '?' . $active_package['purchase_id'] }}">Change
                                        ...
                                        <a href="javascript:void(0)" class="order-completed-btn w-100 bg-red camThin text-white UserCancelPackage" id="cancel_package_model-{{ $active_package['package_id'] . '?' . $active_package['purchase_id'] }}">Cancellation
                                            Request</a>
                                    </div>
                                    @endif
                                    @endforeach
                                ...
                                <div class="tab-pane fade" id="user-completed" role="tabpanel" aria-labelledby="user-completed-tab">
                                        ...
                                        <div class="card-body d-flex gap-3 w-100 p-3">
                                            ...
                                            <div class="d-flex align-items-center gap-3 mb-3 ms-auto mt-auto">
                                                ...
                                                <div class="trmt-card-footer w-100">
                                                    <a href="javascript:void(0)" class="btn write-rev-btn df-center UserWriteReview" id="user_review_model-{{ $completed_package['id'] . '?' . $completed_package['id'] }}">
                                ...
                                <div class="tab-pane fade" id="user-cancelled" role="tabpanel" aria-labelledby="user-cancelled-tab">
                                    @if (!empty($my_cancelled_packages_list))
                                    @foreach ($my_cancelled_packages_list as $cancelled_package)
                                    <div class="card shadow-none mb-3 pkgCard">
                                        <div class="card-body d-flex gap-3 w-100 p-3">
                                            <div class="df-center">
                                                <img src="{{ asset($cancelled_package['company_logo_image_path']) }}" alt="" class="md-img">
                                            </div>
                                            <div class="df-column">
                                                <h5 class="mb-0 card-h4">
...
<div class="modal fade" id="UserChangeInformationModel" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content border-0">
            ...
            <div class="modal-body ">
                <form id="UserChangeInformationForm">
                    <div class="row gy-4">
                        <input type="hidden" name="package_buy_for" id="package_buy_for" value="{{ !empty($patient_information_list['package_buy_for']) ? $patient_information_list['package_buy_for'] : '' }}">
                        <input type="hidden" name="package_id" id="package_id" value="{{ !empty($patient_information_list['package_id']) ? $patient_information_list['package_id'] : '' }}">
                        <input type="hidden" name="id" id="patiant_id" value="{{ !empty($patient_information_list['package_id']) ? $patient_information_list['package_id'] : '' }}">
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="form-label card-h2 fw-bold">*Patient Full Name</label>
                                <input type="text" class="form-control" name="patient_full_name" id="patient_full_name" value="{{ !empty($patient_information_list['patient_full_name']) ? $patient_information_list['patient_full_name'] : '' }}" aria-describedby="foodname" placeholder="{{ !empty($patient_information_list['patient_full_name']) ? $patient_information_list['patient_full_name'] : 'Patient Full Name' }}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="patient_relation" id="patient_relation" value="{{ !empty($patient_information_list['patient_relation']) ? $patient_information_list['patient_relation'] : '' }}" aria-describedby="foodname" placeholder="{{ !empty($patient_information_list['patient_relation']) ? $patient_information_list['patient_relation'] : 'Relationship To You' }}">
                            </div>
                        </div>

                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="form-label card-h2 fw-bold">*Patient E-mail <b class="fs-14 fst-italic">*optional</b></label>
                                <input type="text" class="form-control" name="patient_email" id="patient_email" value="{{ !empty($patient_information_list['patient_email']) ? $patient_information_list['patient_email'] : '' }}" aria-describedby="foodname" placeholder="{{ !empty($patient_information_list['patient_email']) ? $patient_information_list['patient_email'] : 'E-Mail' }}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="patient_contact_no" id="patient_contact_no" value="{{ !empty($patient_information_list['patient_contact_no']) ? $patient_information_list['patient_contact_no'] : '' }}" aria-describedby="foodname" placeholder="{{ !empty($patient_information_list['patient_contact_no']) ? $patient_information_list['patient_contact_no'] : 'Contact Number' }}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-12 my-5">
                            <h6 class="card-h2 fw-bold">*You can also change the patient information from <span class="camptonExtraBold">panel</span> <span class="text-green fw-900">></span>
                                <span class="camptonExtraBold">packages</span>
                            </h6>
                        </div>
                        <div class="col-md-12 d-flex justify-content-center">
                            <a href="javascript:void(0);" id="submit_btn2" class="order-completed-btn bg-green text-black change-patient-from-submit"><span class="fw-bolder me-1">Step 2 :</span> Payment Page</a>
                        </div>
                    </div>
                </form>
            </div>
                    ...
                    <div class="row gy-4">
                        ...
                        <div class="col-md-12">
                            <div class="form-group d-flex flex-column">
                                ...
                                <textarea name="cancellation_detail" id="cancellation_detail" rows="5" class="form-control border-2" placeholder="Please write your treatment cancellation request in detail"></textarea>
                            </div>
                        </div>
                        <div class="col-md-12 d-flex align-items-center gap-2 mb-5 position-relative">
                            <input class="form-check-input" type="checkbox" name="flexCheckChecked" value="" id="flexCheckChecked">
                            <label class="form-check-label card-h2 fw-bold d-block" for="flexCheckChecked">
                                I confirm that I wish cancel my treatment.
                            </label>
                        </div>
                        <div class="col-md-12 d-flex justify-content-center">
                            <a href="javascript:void(0);" class="order-completed-btn bg-red text-white cancel-package-from-submit">Cancel
                                Treatment</a>
                        </div>
                    </div>
                </form>
        ...
        <div class="modal-content border-0">
            ...
            <div class="modal-body p-5">
                <div class="acommodition-content">
                    ...
                    <div class="mt-3">
                        <button class="btn review-sub-btn user-review-from-submit" data-bs-toggle="modal" data-bs-target="#hotelcompletedmodel2" data-bs-dismiss="modal">Submit</button>
                    </div>
                </div>
            </div>
        </div>
