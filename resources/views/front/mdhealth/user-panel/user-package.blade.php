                                                ...
                                                <div class="treatment-card-div mb-3">
                                                        ...
                                                        <div class="row card-row">
                                                            ...
                                                            <div class="col-md-8 justify-content-start ps-0">
                                                                <div class="trmt-card-body">
                                                                    ...
                                                                    <h6 class="mb-1 fsb-1">
                                                                        {{ $active_package['product_category_name'] }}</h6>
                                                                    <div
                                                    ...
                                                    <div class="treatment-card-btns d-flex justify-content-around gap-3">
                                                        <a href="#"
                                                            ...
                                                            Details</a>
                                                        <a href="#"
                                                            class="order-completed-btn w-100 bg-black fsb-2 text-white">Change
                                                            Patient Information</a>
                                                        <a href="#"
                                                            class="order-completed-btn w-100 bg-red fsb-2 text-white">Cancellation
                                                            Request</a>
                                                    </div>
                                                </div>
                                            @endforeach
                                                        ...
                                                        <div class="row card-row">
                                                            ...
                                                            <div class="col-md-6 justify-content-start ps-0">
                                                                <div class="trmt-card-body">
                                                                    ...
                                                                    <h6 class="mb-1 fsb-1">Time left to treatment: <span
                                                                            class="text-green">Completed!</span></h6>
                                                                </div>
                                                            </div>
                                                            <div
                                                        ...
                                                        <div class="row card-row">
                                                            ...
                                                            <div class="col-md-10 justify-content-start ps-0">
                                                                <div class="trmt-card-body">
                                                                    ...
                                                                    <h6 class="mb-1 fsb-1">Time left to treatment: <span
                                                                            class="text-red">Cancelled</span></h6>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
