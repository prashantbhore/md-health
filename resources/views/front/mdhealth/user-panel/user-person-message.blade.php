            ...
            <div class="d-flex gap-3">
                ...
                <div class="w-761">
                    <div class="card panel-right">
                        <div class="card-body d-flex" style="min-height:600px">
                            <div class="message-div d-flex justify-content-between flex-column w-100 ">
                                <div class="message-header">
                                    <h5
                                        class="d-flex align-items-center justify-content-between bg-light fw-700 p-3 mb-3 fsb-1 mx-3">
                                        <div class="d-flex align-items-center gap-3">
                                            <img class="" src="{{ asset('front/assets/img/Memorial.svg') }}"
                                        ...
                                        <a href="{{ url('user-message') }}"
                                            ...
                                            <img src="{{ asset('front/assets/img/backPage.png') }}" alt=""> <span
                                ...
                                <div class="footer-message-div mx-3">
                                    <div class="input-file-div d-flex align-items-center justify-content-end gap-2 mb-3">
                                        <a data-bs-toggle="modal" data-bs-target="#LiveRequestModal"
                                            class="go-live df-center gap-1 text-decoration-none text-light"
                                            style="height: 33px;width:265px;cursor:pointer">
                                    ...
                                    <div class="write-message">
                                        <textarea class="form-control border-0" id="productstext" rows="3" placeholder="Your message here"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="#" class="user-profile-form" method="php" id="conversation_form">
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                <label for="*Conversation Subject" class="form-label">*Conversation Subject</label>
                                <select name="conversation_subject" id="conversation_subject" class="form-select">
                                    <option value="About Treatments" selected disabled>About Treatments</option>
                                    <option value="About Service">About Service</option>
                                    <option value="Technical">Technical</option>
                                </select>
                            </div>
                            <div class="col-md-12 mb-3">
                                <label for="*Conversation Date" class="form-label">*Conversation Subject</label>
                                <select name="conversation_date" id="conversation_date" class="form-select">
                            ...
                            <div class="col-md-12 mb-3 text-center">
                                <button class="btn btn-md rounded btn-text submit" type="submit"
                                    style="height: 48px;width:305px">Submit</button>
                            </div>
                        </div>
                    </form>
                </div>
    ...
    <script>
        $(document).ready(function() {
            $('.btn').click(function(e) {
                ...
                e.preventDefault();
                if (clickedBtn.hasClass('btn-selected')) {
                    alert('not avialable');
                }
                const selectedTime = clickedBtn.text();
                // alert(clickedBtn.text());
                $('.btn').removeClass('btn-vselected');
                clickedBtn.toggleClass('btn-vselected');
            });
            ...
            $('#conversation_form').validate({
                ...
                messages: {
                    conversation_subject: {
                        required: 'Please select a conversation subject';
                    }
                    conversation_date: {
                        required: 'Please select a date for the call';
                    }
                },
