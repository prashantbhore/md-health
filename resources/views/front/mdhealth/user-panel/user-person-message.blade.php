...
<style>
    ...
    .footer-message-div .input-file-div a{
        padding: 10px 20px;
        background: #FE4949;
        border-radius: 25px;
        line-height: 0;
                        ...
                        <div class="message-div d-flex justify-content-between flex-column w-100 ">
                            <div class="message-header">
                                <h5 class="d-flex align-items-center justify-content-between bg-light fw-700 p-4 mb-3 fsb-1">
                                    <span class="d-flex align-items-center gap-3">
                                        <img class="" src="{{asset('front/assets/img/Memorial.svg')}}" alt="" style="height: 35px;width: 35px;object-fit: contain;">    
                                    Ali Danish</span>
                                    <a href="{{url('user-message')}}" class="d-flex align-items-center text-dark gap-1 text-decoration-none">
                                ...
                                <div class="person-message-div mb-4">
                                    <div class="treatment-card df-start w-100 mb-1">
                                        <div class="d-flex align-items-center justify-content-evenly">
                                            <img class="mx-4" src="{{asset('front/assets/img/Memorial.svg')}}" alt="" style="height: 35px;width: 35px;object-fit: contain;">
                            ...
                            <div class="footer-message-div">
                                <div class="input-file-div d-flex align-items-center justify-content-end gap-2 mb-3">
                                    <a href="{{url('live-consultation-appoinment')}}" class="d-flex align-items-center justify-content-center">
