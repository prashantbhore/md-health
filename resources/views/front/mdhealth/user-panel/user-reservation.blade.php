                                                ...
                                                <div class="row mb-3">
                                                    <div class="col">
                                                        <div class="view-menu-div1 mt-4">
                                                            <p class="user-res-p4" style="color: #4cdb06;">Hotel Full Address</p>
                                                            <p class="user-res-p2">
                                                            ...
                                                            <div class="row">
                                                                <div class="col">
                                                                    <p class="user-res-p4" style="color: #4cdb06;">Hotel Enter Date</p>
                                                                    <p class="user-res-p5"><span class="" style="color: #4cdb06;">Enter Date:</span><span class="">12 December 2023 /14:00</span></p>
                                                                    <p class="user-res-p5"><span class="" style="color: #f31d1d;">Exit Date:</span><span class="">19 December 2023 /14:00</span></p>
                                                                </div>
                                                                <div class="col user-res-p4">
                                                                    <p class="" style="color: #4cdb06;">Total Price</p>
                                                                    <p class="">1,500.00$</p>
                                                                </div>
                                                            </div>
                                                            <div class="">
                                                                <p class="user-res-p4" style="color: #4cdb06;">Room Details</p>
                                                            ...
                                                            <div class="text-end">
                                                                <button class="user-res-btn2" data-bs-toggle="modal" data-bs-target="#exampleModal12">Cancellation Request</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="card shadow-none mb-4 pkgCard">
                                                    <div class="card-body d-flex gap-3 w-100 p-4">
                                                        ...
                                                        <div class="df-column">
                                                            <h6 class="card-h1 d-flex align-items-center gap-3">
                                                                <span>Renaissence Instanbul</span>
                                                                <p class="card-p1 mb-0"><img src="{{ 'front/assets/img/mdBookings/bi_star-fill.png' }}" alt="" /> 4 Stars Hotel</p>
                                                            </h6>
                                                ...
                                                <div class="row mb-3">
                                                    <div class="col">
                                                        <div class="view-menu-div2 mt-4">
                                                            <p class="user-res-p4" style="color: #4cdb06;">Acent Full Adress</p>
                                                            <p class="user-res-p2">
                                                                Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim Besiktas / Istanbul
                                                            </p>
                                                            ...
                                                            <div class="row">
                                                                <div class="col">
                                                                    <p class="user-res-p4" style="color: #4cdb06;">Vehicle Delivery Date</p>
                                                                    <p class="user-res-p5"><span class="" style="color: #4cdb06;">Pick-Up Date:</span><span class="">12 December 2023 /14:00</span></p>
                                                                    <p class="user-res-p5"><span class="" style="color: #f31d1d;">Return Date:</span><span class="">19 December 2023 /14:00</span></p>
                                                                </div>
                                                                <div class="col user-res-p4">
                                                                    <p class="" style="color: #4cdb06;">Total Price</p>
                                                                    <p class="">1,500.00$</p>
                                                            ...
                                                            <div class="">
                                                                <p class="user-res-p4" style="color: #4cdb06;">Vehicle Details</p>
                                                                <div class="d-flex gap-5">
                                                                    <div class="user-res-p6">
                                                                        <p class="">
                                                                            Economy
                                                            ...
                                                            <div class="text-end">
                                                                <button class="user-res-btn2" data-bs-toggle="modal" data-bs-target="#exampleModal21">Cancellation Request</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row mb-3">
                                                    <div class="col">
                                                        <div class="view-menu-div2 mt-4">
                                                            ...
                                                            <p class="user-res-p4 m-0" style="color: #4cdb06;">Flight Info</p>
