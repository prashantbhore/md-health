                                ...
                                <div class="tab-pane fade show active" id="patient-details" role="tabpanel"
                                    ...
                                    <div class="tab-div ">
                                        ...
                                        <div class="container tab-content" id="myTabContent">
                                                ...
                                                <div class="modal-dialog modal-lg modal-dialog-centered"
                                                    ...
                                                    <div class="modal-content ">
                                                        <div class="position-relative overflow-hidden"
                                                            style="height: 15rem">
                                                            <img src="{{ 'front/assets/img/user/Group 20.png' }}"
                                                                alt="" class="position-relative"
                                                                style="top: -15rem;left:-1rem">
                                                            <button type="button btn-close z-index-1" class="btn-close"
                                                        ...
                                                        <div class="modal-body m-0">
                                                            ...
                                                            <div class="form-check mt-2">
                                                                ...
                                                                <label class="form-check-label user-res-p7"
                                                                    for="flexCheckDefault">
                                                                    I confirm that I wish cancel my reservation
                                                                </label>
                                                            </div>
                                                            <div class=" text-center mt-3 mb-3">
                                                                <button class="user-res-btn3" data-bs-toggle="modal"
                                                                    data-bs-target="#exampleModalkd"
                                            ...
                                            <div class="modal fade" id="exampleModalkd" tabindex="-1"
                                                aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog modal-lg modal-dialog-centered"
                                                    style="width: 38rem">
                                                    <div class="modal-content">
                                                        <div class="">
                                                            <button type="button" class="btn-close"
                                                                style="left:unset;top:14px;right:14px"
                                                                data-bs-dismiss="modal" aria-label="Close"></button>
                                                        </div>
                                                        <div class="modal-body mt-4 mb-4">
                                                            <div
                                                                ...
                                                                <p class="">
                                                                    <img src="{{ 'front/assets/img/user/md-red@.png' }}"
                                                                        alt="" class="">
                                                                </p>
                                                                <p class="user-res-p9">We received your <span
                                                                        style="color: #F31D1D">cancellation request</span>
                                                                </p>
                                                                <p class="user-res-p7">our customer supports will contact
                                                                    you for your cancellation request soon.</p>
                                                                <div class=" text-center mt-5 mb-3">
                                                                    <button class="user-res-btn3"
                                                    ...
                                                    <div class="col-8">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-8 d-flex flex-column justify-content-between">
                                                                ...
                                                                <div class="m-0">
                                                                    <button
                                                                        class=" user-reservation-btn1 menu-detail-btn">Reservation
                                                                        Details</button>
                                                                </div>
                                                                {{-- </div> --}}
                                                            </div>
