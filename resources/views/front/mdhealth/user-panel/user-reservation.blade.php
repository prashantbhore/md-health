...
@section('content')
    ...
    <div class="content-wrapper">
                                                ...
                                                <div class="row mb-5">
                                                    ...
                                                    <div
                                                        ...
                                                        <button class="user-reservation-btn2" data-bs-toggle="modal"
                                                            data-bs-target="#TransportationView"
                                                            data-bs-dismiss="modal">Write Review</button>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="tab-pane fade" id="patient-message" role="tabpanel"
                                    ...
                                    <div class="tab-div ">
                                        ...
                                        <ul class="nav nav-tabs d-flex justify-content-evenly" id="myTab"
                                            ...
                                            <li class="nav-item" role="presentation">
                                                <button class="nav-link active" id="saleactive-tab" data-bs-toggle="tab"
                                                    data-bs-target="#userflight1" type="button" role="tab"
                                                    aria-controls="userflight1" aria-selected="true">Active</button>
                                            </li>
                                            <li class="nav-item" role="presentation">
                                                <button class="nav-link" id="sale-userflight-tab2" data-bs-toggle="tab"
                                                    data-bs-target="#userflight2" type="button" role="tab"
                                                    aria-controls="userflight2" aria-selected="false">Completed</button>
                                            </li>
                                            <li class="nav-item" role="presentation">
                                                <button class="nav-link" id="sale-userflight-tab3" data-bs-toggle="tab"
                                                    data-bs-target="#userflight33" type="button" role="tab"
                                                    aria-controls="userflight33" aria-selected="false">Cancelled</button>
                                            </li>
                                        </ul>
                                        <div class="container filter-div">
                                            <div class="search-div">
                                        ...
                                        <!-- Tab panes -->
                                        <div class="container tab-content" id="myTabContent">
                                            <div class="tab-pane fade show active" id="userflight1" role="tabpanel"
                                                aria-labelledby="saleactive-tab1">
                                                <div class="row mb-5">
                                                    <div class="col-8">
                                                        <div class="row">
                                                            <div class="col text-center">
                                                                ...
                                                                <p class="m-0">
                                                                    <img src="{{ 'front/assets/img/mdBookings/Group 5.png' }}"
                                                                        alt="">
                                                                </p>
                                                            ...
                                                            <div class="col-8 d-flex flex-column justify-content-between">
                                                                {{-- <div class="d-flex flex-column justify-content-between"> --}}
                                                                <div
                                                                    class="d-flex flex-column align-items-start gap-2 m-0 ">
                                                                    {{-- <h6 class="m-0 user-res-p1">Garenta Rental</h6> --}}
                                                                    <p class="user-res-p1">
                                                                        <span class="">
                                                                            <img src="{{ 'front/assets/img/mdBookings/fligthTo.png' }}"
                                                                                alt="">
                                                                        </span>
                                                                ...
                                                                <div class="m-0">
                                                                    <button
                                                                        class=" user-reservation-btn1 menu-detail-btn2">Ticket
                                                                        Details</button>
                                                                </div>
                                                                {{-- </div> --}}
                                                            </div>
                                                    ...
                                                    <div class="col d-flex flex-column align-items-end">
                                                        <p class="m-0">
                                                            <img src="{{ 'front/assets/img/mdBookings/airlinesLogo.png' }}"
                                                                alt="">
                                                        </p>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col">
                                                        <div class="view-menu-div2 mt-4">
                                                            ...
                                                            <div class="d-flex gap-2 m-0">
                                                                <p class="user-res-p5"><span
                                                                        style="color: #4CDB06">Departure Time: </span> 12
                                                                    December 2023 - 16:30</p>
                                                                <p class="user-res-p5"><span
                                                                        style="color: #F31D1D">Departure Airport: </span>
                                                            ...
                                                            {{-- <p class=""> --}}
                                                            <img src="{{ 'front/assets/img/user/Group 26.png' }}"
                                                                alt="" style="width: 100%">
                                                            {{-- </p> --}}
                                                            <div class="text-end mt-4">
                                                                <button class="user-res-btn2" data-bs-toggle="modal"
                                                                    data-bs-target="#FlightModelBox1">Cancellation
                                                                    Request</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="tab-pane fade" id="userflight2" role="tabpanel"
                                                aria-labelledby="sale-userflight-tab2">
                                                <div class="row mb-4">
                                                    {{-- <div class="col"> --}}
                                                    {{-- <div class="row"> --}}
                                                    <div class="col text-center">
                                                    ...
                                                    <div
                                                        class="col d-flex flex-column justify-content-between align-items-end">
                                                        ...
                                                        <div class="">
                                                            <button class="user-reservation-btn2" data-bs-toggle="modal"
                                                                data-bs-target="#UserFlightView">Write Review</button>
                                                        </div>
                                                    </div>
                                                    {{-- </div> --}}
                                                    {{-- </div> --}}
                                            ...
                                            <div class="tab-pane fade" id="userflight33" role="tabpanel"
                                                aria-labelledby="sale-userflight-tab3">
                                                <div class="row mb-4">
                                                    <div class="col text-center">
                                                        <p class="user-res-p6 m-0" style="font-weight: 400">
                                                            Stockholm Airport</p>
                                                    ...
                                                    <div class="col-9 d-flex flex-column justify-content-between">
                                                        ...
                                                        <p class=""><span class="user-res-p3">Status:&nbsp;&nbsp;</span><span
                                                                class="user-res-p11">Cancelled</span></p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
        ...
        {{-- Hotel Model Box 2 --}}
        <div class="modal fade" id="exampleModalkd" tabindex="-1" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="acommodition-content">
                            ...
                            <div class="mt-3">
                                <button class="user-res-btn4" data-bs-toggle="modal"
            ...
            <div class="modal-dialog modal-lg modal-dialog-centered" style="width:48%;">
                <div class="modal-content ">
                    ...
                    <div class="model-body text-center">
                        <p class="mt-3">
                            <img src="{{ 'front/assets/img/user/lucide_party-popper.png' }}" alt=""
                                class="">
                        </p>
        ...
        {{-- Vehicle Model Box 1 --}}
        <div class="modal fade" id="exampleModal21" tabindex="-1" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
            <div class="modal-dialog modal-lg modal-dialog-centered" style="width:48%;">
                <div class="modal-content ">
                    <div class="position-relative overflow-hidden" style="height: 15rem">
        ...
        {{-- Vehicle Model Box 2 --}}
        <div class="modal fade" id="exampleModal25" tabindex="-1" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
            <div class="modal-dialog modal-lg modal-dialog-centered" style="width: 38rem">
                <div class="modal-content">
                    <div class="">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="acommodition-content">
                            ...
                            <div class="mt-3">
                                <button class="user-res-btn4" data-bs-toggle="modal"
                                    data-bs-target="#UserVehicleView2" data-bs-dismiss="modal">Submit</button>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="modal fade" id="UserVehicleView2" tabindex="-1" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog modal-lg modal-dialog-centered" style="width:48%;">
                <div class="modal-content ">
                    <div class="position-relative overflow-hidden" style="height: 15rem">
                        <img src="{{ 'front/assets/img/user/Group 24.png' }}" alt=""
                            class="position-relative" style="top: -15rem;left:-1rem">
                        <button type="button btn-close z-index-1" class="btn-close" data-bs-dismiss="modal"
                            aria-label="Close" style='opacity:1'></button>
                    </div>
                    <div class="model-body text-center">
        ...
        {{-- Flight Model Box 1 --}}
        <div class="modal fade" id="FlightModelBox1" tabindex="-1" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
            <div class="modal-dialog modal-lg modal-dialog-centered" style="width:48%;">
                <div class="modal-content ">
                    <div class="position-relative overflow-hidden" style="height: 15rem">
                        <img src="{{ 'front/assets/img/user/Group 20.png' }}" alt=""
                            class="position-relative" style="top: -15rem;left:-1rem">
                        <button type="button btn-close z-index-1" class="btn-close" data-bs-dismiss="modal"
                            aria-label="Close" style="opacity: 1"></button>
                    </div>
                    <div class="modal-body m-0">
                        ...
                        <div class=" text-center mt-3 mb-3">
                            <button class="user-res-btn3" data-bs-toggle="modal" data-bs-target="#UserFlightView2"
                                data-bs-dismiss="modal">Submit Cancel
                                Request</button>
                        </div>
                    </div>
        ...
        {{-- Flight Model Box 2 --}}
        <div class="modal fade" id="UserFlightView2" tabindex="-1" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
            <div class="modal-dialog modal-lg modal-dialog-centered" style="width: 38rem">
                <div class="modal-content">
                    <div class="">
                        <button type="button" class="btn-close" style="left:unset;top:14px;right:14px"
                            data-bs-dismiss="modal" aria-label="Close" style="opacity: 1"></button>
                    </div>
                    <div class="modal-body mt-4 mb-4">
                        <div class="d-flex flex-column justify-content-center align-items-center ">
                            <p class="">
        ...
        {{-- Flight Model Box 3 --}}
        <div class="modal fade" id="UserFlightView" tabindex="-1" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
            <div class="modal-dialog modal-lg modal-dialog-centered" style="width: 47%">
                <div class="modal-content">
                    <div class="modal-header border-0">
                    ...
                    <div class="modal-body">
                        <div class="acommodition-content">
                            ...
                            <div class="mt-3">
                                <button class="user-res-btn4" data-bs-toggle="modal"
                                    data-bs-target="#UserFlight2View2" data-bs-dismiss="modal">Submit</button>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        {{-- Flight Model Box 4 --}}
        <div class="modal fade" id="UserFlight2View2" tabindex="-1" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
            <div class="modal-dialog modal-lg modal-dialog-centered" style="width:48%;">
                <div class="modal-content ">
                    <div class="position-relative overflow-hidden" style="height: 15rem">
...
@section('script')
    <script>
        $(".upPackageLi1").addClass("activeClass");
        $(".upPackage1").addClass("md-active");
    </script>
    <script>
        $(".view-menu-div1").hide();
