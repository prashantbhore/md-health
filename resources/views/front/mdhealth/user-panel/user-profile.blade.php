                        ...
                        <form action="{{url('update-customer-profile')}}" class="user-profile-form" method="post" id="updatecustpro">
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="First Name" name="first_name" value="{{$customer_list->first_name?$customer_list->first_name:''}}">
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label for="Last Name" class="form-label">Last Name</label>
                                    <input type="text" class="form-control" placeholder="Last Name" name="last_name" value="{{$customer_list->last_name?$customer_list->last_name:''}}">
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label for="E-mail" class="form-label">E-mail</label>
                                    <input type="text" class="form-control" placeholder="E-mail" name="email" value="{{$customer_list->email?$customer_list->email:''}}">
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label for="Phone" class="form-label">Phone</label>
                                    <input type="text" class="form-control" placeholder="Phone" name="phone" value="{{$customer_list->phone?$customer_list->phone:''}}">
                                </div>
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select name="country_id" id="country_id" class="form-select">
                                        ...
                                        @foreach ($countries as $country)
                                            <option value="{{ $country->id }}"{{ ($country->id==$customer_list->country_id)?'selected':'' }}>{{ $country->country_name }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select name="city_id" id="city_id" class="form-select">
                                        ...
                                        @foreach ($cities as $city)
                                            <option value="{{ $city->id }}"{{ ($city->id==$customer_list->city_id)?'selected':'' }}>{{ $city->city_name }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select name="gender" id="gender" class="form-select">
                                        {{-- <option value="" disabled>Choose</option> --}}
                                        <option value="Male"{{$customer_list->gender=='Male'?'selected':''}}>Male</option>
                                        <option value="Female"{{$customer_list->gender=='Female'?'selected':''}}>Female</option>
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <textarea name="address" id="" cols="" rows="3" class="form-control" placeholder="Address"> {{$customer_list->address?$customer_list->address:''}}</textarea>
                                </div>
                                <div class="col-md-12 mb-3">
