                        ...
                        <div class="card-body">
                            <div class="mediacal-message-div mb-3">
                                <div class="message-body">
                                    ...
                                    <a href="{{ set_conversation_id(!empty($conversation['converstion_id']) ? $conversation['converstion_id'] : '', !empty($conversation['latest_message']) ? $conversation['latest_message'] : '') }}">
