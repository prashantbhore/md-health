                        ...
                        <div class="form-div">
                            ...
                            <div class="card-body">
                                            ...
                                            @foreach ($conversations as $conversation)
                                                <a href="{{ set_conversation_id($conversation['converstion_id']) }}">
                                                    @if ($conversation['is_latest_message'] == 1)
                                                        ...
                                                        @else
                                                            <div
                                                                class="treatment-card d-flex align-items-center gap-3 w-100 mb-3 ">
                                                    @endif
                                                    <div class="">
                                                        <img src="{{ asset('front/assets/img/msg.png') }}" alt="" />
                                                    </div>
                                                    <div class="w-80">
                                                        <h5 class="card-h1">Writen By:
                                                            {{ !empty($conversation['written_by']) ? $conversation['written_by'] : '' }}
                                                        </h5>
                                                        <p class="card-p1 mb-0">
                                                            {{ !empty($conversation['latest_message']) ? $conversation['latest_message'] : '' }}
                                                        </p>
                                                        @if ($conversation['is_latest_message'] == 1)
                                    ...
                                    {{-- <a href="{{ url('user-person-message') }}">
                                            <div class="treatment-card d-flex align-items-center gap-3 w-100 mb-3 ">
                                                ...
                                                <div class="w-80">
                                                    ...
                                                    <p class="card-p1 mb-0">Lorem ipsum dolor sit amet, consectetur
                                ...
                                <div class="no-msg-div d-flex align-items-center flex-column justify-content-around"
                                    ...
                                    <a href="{{ url('user-live-appoinment') }}" class="go-live df-center gap-1">
