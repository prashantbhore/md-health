            ...
            <div class="col-md-9">
                <div class="card card-body">
                    ...
                    <div class="reports-list">
                         ...
                         {{-- {{dd($report['provider_data']['company_name'])}} --}}
                            ...
                            <div class="row card-row align-items-center justify-content-evenly m-0">
                                ...
                                <div class="col-md-6 justify-content-start ps-0">
                                    <div class="trmt-card-body">
                                        <h5 class="dashboard-card-title">{{!empty($report['provider_data']['company_name'])?$report['provider_data']['company_name']:''}}</h5>
                                ...
                                <div class="view-more-reports d-flex justify-content-between">
                                    <div class="view-more-left d-flex align-items-center gap-3">
                                        ...
                                        <div class="view-more-content">
                                            <h5 class="dashboard-card-title">{{!empty($report_data['report_title'])?$report_data['report_title']:''}}</h5>
                                            @php
                                          ...
                                          @endphp
                                            <h5 class="mb-0 fsb-1 fw-600">{{!empty($formattedDate)?$formattedDate:''}}</h5>
                                        </div>
                                    </div>
