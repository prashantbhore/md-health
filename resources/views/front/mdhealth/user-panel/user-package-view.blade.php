                            ...
                            <div class="card-body p-4">
                                <div class="d-flex gap-3 w-100">
                                    <div class="df-center">
                                        ...
                                        <img src="{{ asset($data['company_logo_image_path']) }}" alt="" style="height: 109px;border-radius:3px">
                                        @endif
                                ...
                                <div class="user-package-details">
                                    <div class="user-package-body">
                                        <div class="user-details-body mb-4">
                                            ...
                                            <ul class="ps-0 list-unstyled">
                                                <li>
                                                    ...
                                                    @endif
                                                    Accomodation
                                                    <a href="javascript:void(0);" id="accomodation_modal" data-bs-toggle="modal" data-bs-target="#AccommodationView">View Details</a>
                                                </li>
                                                ...
                                                <li>
                                                    ...
                                                    @endif
                                                    Transportation
                                                    <a href="#" id="transportation_modal" data-bs-toggle="modal" data-bs-target="#TransportationView">View Details</a>
                                                </li>
                                                <li>
                                                    @if ($tour == 1)
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 10 10" fill="none">
                                                    ...
                                                    @endif
                                                    Tour
                                                    <a href="#" id="" data-bs-toggle="modal" data-bs-target="#TourView">View Details</a>
                                            ...
                                            <div class="acdm-btns pt-3 df-start gap-3">
                                                <button target="1" class="showSingle btn add-btn text-white fw-lighter">My Details</button>
                                                <button target="2" class="showSingle btn add-btn bg-transparent text-black">My Documents</button>
                                            </div>
                                            ...
                                            <div id="ShowDiv2" class="view-menu-div targetDiv mt-5">
                                                ...
                                                <div class="gallery">
                                                    ...
                                                    <a href="{{ $document['customer_document_image_path'] }}" class="glightbox">
                                                        <img src="{{ $document['customer_document_image_path'] }}" alt="image" />
                                        ...
                                        <form action="{{ url('/user-credit-card-pay') }}" id="payment_form" method="POST">
                                            @csrf
                                            <input type="hidden" name="package_id" value="{{ !empty($data['package_id']) ? $data['package_id'] : '' }}">
                                            <input type="hidden" name="package_percentage_price" value="{{ !empty($pending_percent) ? $pending_percent : '' }}">
                                            <input type="hidden" name="sale_price" value="{{ !empty($treatment_information['sale_price']) ? $treatment_information['sale_price'] : '' }}">
                                            <input type="hidden" name="pending_payment" value="{{ !empty($data['pending_payment']) ? $data['pending_payment'] : '' }}">
                                            <input type="hidden" name="purchase_id" value="{{ !empty($data['purchase_id']) ? $data['purchase_id'] : '' }}">
                                            <div class="user-details-footer">
                                                ...
                                                <div class="user-payment-date mb-3">
                                                    <div class="d-flex justify-content-between">
                                                        <div class="payment-left-div">
                                                            ...
                                                            <div class="fsb-2 text-green paymt-green-text">Payment Completed.</div>
                                                        </div>
                                                ...
                                                <div class="payment-paid-div">
                                                    <div class="user-payment-date paid-percentage fsb-1 fw-600 d-flex flex-column ps-3 justify-content-center">
                                                        <span class="user-percentage fsb-1 fw-600">
                                                            {{ $pending_percent }} (<span>{{ !empty($data['pending_payment']) ? $data['pending_payment'] : '' }} <span class="lira">₺</span>)</span>
                                                        </span>
                                                        <span class="fsb-2 paymt-green-text" style="color: #F3771D;">Pending</span>
                                                    </div>
                                                    <a href="javascript:void(0)" class="payment-pay-btn df-center">
                                                        Pay Now
                                                    </a>
                                                </div>
                                                @endif
...
<div class="modal fade" id="AccommodationView" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="modal-body p-5">
                <div class="acommodition-content">
                    ...
                    <div class="acmdn-notes mb-1">
                        <h6 class="card-h1 camptonBold" style="letter-spacing: -1.12px;">Notes <span class="campton fst-italic fs-14">*Optional</span></h6>
                        <div class="for-textarea-div position-relative">
                            <textarea name="" id="" rows="4" class="form-control border-2" placeholder="Write notes if any" style="resize: none;"></textarea>
...
<div class="modal fade" id="TransportationView" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0">
            <div class="modal-header border-0 p-5 pb-0">
                <h5 class="modal-title modal-h1 text-start camptonExtraBold" id="">Transportation Details</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body p-5">
                <div class="acommodition-content">
                        ...
                        <ul style="padding: 0;list-style: none;" class="mt-2">
                            ...
                            <li>
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                                    <path d="M7.49967 15.8334H12.4997V17.5001H7.49967C5.19967 17.5001 3.33301 15.6334 3.33301 13.3334V5.83343H4.99967V13.3334C4.99967 14.7168 6.11634 15.8334 7.49967 15.8334ZM8.68301 4.50843C9.33301 3.85843 9.33301 2.8001 8.68301 2.1501C8.03301 1.5001 6.97467 1.5001 6.32467 2.1501C5.67467 2.8001 5.67467 3.85843 6.32467 4.50843C6.97467 5.16676 8.02467 5.16676 8.68301 4.50843ZM9.58301 7.5001C9.58301 6.58343 8.83301 5.83343 7.91634 5.83343H7.49967C6.58301 5.83343 5.83301 6.58343 5.83301 7.5001V12.5001C5.83301 13.8834 6.94967 15.0001 8.33301 15.0001H12.558L15.4747 17.9168L16.6663 16.7251L12.4413 12.5001H9.58301V7.5001Z" fill="#111111" />
                                </svg>
                                7+1
                            </li>
                            @endif
                            ...
                            <li>
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                                    <path d="M5 1.66675H7.5C7.73333 1.66675 7.94167 1.75841 8.09167 1.90841L9.825 3.65008L10.4917 2.99175C10.8333 2.66675 11.25 2.50008 11.6667 2.50008H16.6667C17.0833 2.50008 17.5 2.66675 17.8417 2.99175L18.675 3.82508C19 4.16675 19.1667 4.58341 19.1667 5.00008V15.8334C19.1667 16.2754 18.9911 16.6994 18.6785 17.0119C18.3659 17.3245 17.942 17.5001 17.5 17.5001H9.16667C8.72464 17.5001 8.30072 17.3245 7.98816 17.0119C7.67559 16.6994 7.5 16.2754 7.5 15.8334V6.66675C7.5 6.25008 7.66667 5.83341 7.99167 5.49175L8.65 4.82508L7.15833 3.33341H5V1.66675ZM11.6667 4.16675V5.83341H16.6667V4.16675H11.6667ZM12.0083 9.16675L10.3417 7.50008H9.16667V8.67508L10.8333 10.3417V12.9917L9.16667 14.6584V15.8334H10.3417L12.0083 14.1667H14.6583L16.325 15.8334H17.5V14.6584L15.8333 12.9917V10.3417L17.5 8.67508V7.50008H16.325L14.6583 9.16675H12.0083ZM12.5 10.8334H14.1667V12.5001H12.5V10.8334Z" fill="#111111" />
                                </svg>
                                Gasoline
                            </li>
                            @endif
                    ...
                    <div class="acmdn-notes mb-1">
                        <h6 class="card-h1 camptonBold" style="letter-spacing: -1.12px;">Notes<i class="fsb-2">*Optional</i></h6>
                        <div class="for-textarea-div position-relative">
                            <textarea name="" id="" rows="4" class="form-control border-2" placeholder="Write notes if any" style="resize: none;"></textarea>
                            <div class="text-area-footer">
                                <span>0 / 200</span>
