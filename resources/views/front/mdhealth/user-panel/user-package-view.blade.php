@section('php')
    @php
        ...
        $avialable_tour_services = false;
        $tour_breakfast = $tour_seven = $tour_gas = $tour_smoking = $tour_wifi = false;
        if (!empty($data['tour_view']['other_services'])) {
            $avialable_transportation_services = true;
            foreach ($data['tour_view']['other_services'] as $service) {
                switch (str_replace(' ', '', strtolower($service))) {
                    case 'breakfast&dinner':
                        $tour_breakfast = true;
                        break;
                                    ...
                                    <div class="d-flex gap-3 w-100">
                                        <div class="df-center">
                                            @if (!empty($data['company_logo_image_path']))
                                                <img src="{{ asset($data['company_logo_image_path']) }}" alt=""
                                                    class="pkgImg" style="object-fit:contain;">
                                            @endif
                                        ...
                                        <div class="df-column">
                                            <div class="trmt-card-body">
                                                ...
                                                <h6 class="card-p2 fw-bold">Time left to treatment:
                                                    {{ !empty($data['treatment_start_date']) ? $data['treatment_start_date'] : '' }}
                                                </h6>
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                <div class="d-flex justify-content-between mb-3">
                                                    ...
                                                    <span>
                                                        <h5 class="card-h4 d-inline-block camptonBold">Your Case No <p
                                                                class="text-green mb-0 d-inline-block">
                                                                {{ !empty($data['case_no']) ? $data['case_no'] : '' }}</p>
                                                        </h5>
                ...
                <div class="modal-body p-5 position-relative">
                    <div class="acommodition-content ">
                        <div class="acmdn-head mb-4">
                            ...
                            <h6 class="card-p2 fw-bold">
                                {{ !empty($data['tour_view']['tour_name']) ? $data['tour_view']['tour_name'] : '' }}
                            </h6>
                        </div>
                        <div class="acmdn-head mb-4">
                            ...
                            <h6 class="card-p2 fw-bold">
                                <!-- {{ !empty($data['transportation_view']['vehicle_model_id']) ? $data['transportation_view']['vehicle_model_id'] : '' }} -->
                                {{ !empty($data['tour_view']['tour_days']) ? $data['tour_view']['tour_days'] : '' }}
                            </h6>
                        </div>
                        <div class="acmdn-hotel-details">
                            <h6 class="card-h1 mb-0 camptonBold" style="letter-spacing: -1.12px;">Tour Description</h6>
                            <h6 class="card-p2 fw-bold">
                                {{ !empty($data['tour_view']['tour_description']) ? $data['tour_view']['tour_description'] : '' }}
                            </h6>

                            <ul style="padding: 0;list-style: none;" class="mt-2">
                                @if ($avialable_tour_services == 1)
                                    @if ($tour_breakfast == 1)
                                        <li>
                                            <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15"
                                                viewBox="0 0 16 16" fill="none">
