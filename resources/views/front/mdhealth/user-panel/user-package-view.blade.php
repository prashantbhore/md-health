                                        ...
                                        <div class="user-package-body">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <div class="form-group position-relative mb-3">
                                                                        ...
                                                                        <input type="text" class="form-control" id="foodname" aria-describedby="foodname" placeholder="First Name">
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <div class="form-group position-relative mb-3">
                                                                        <label class="form-label">Last Name</label>
                                                                        <input type="text" class="form-control" id="foodname" aria-describedby="foodname" placeholder="Last Name">
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <div class="form-group position-relative mb-3">
                                                                        <label class="form-label">E-Mail</label>
                                                                        <input type="text" class="form-control" id="foodname" aria-describedby="foodname" placeholder="E-Mail">
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <div class="form-group position-relative mb-3">
                                                                        <label class="form-label">Country</label>
                                                                        <input type="text" class="form-control" id="foodname" aria-describedby="foodname" placeholder="Country">
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <div class="form-group position-relative mb-3">
                                                                        <label class="form-label">City</label>
                                                                        <input type="text" class="form-control" id="foodname" aria-describedby="foodname" placeholder="City">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <div class="form-group position-relative mb-3">
                                                                        ...
                                                                        <input type="text" class="form-control" id="foodname" aria-describedby="foodname" placeholder="Hospital Name">
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <div class="form-group position-relative mb-3">
                                                                        <label class="form-label">Treatment</label>
                                                                        <input type="text" class="form-control" id="foodname" aria-describedby="foodname" placeholder="Treatment">
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <div class="form-group position-relative mb-3">
                                                                        <label class="form-label">Treatment Period</label>
                                                                        <input type="text" class="form-control" id="foodname" aria-describedby="foodname" placeholder="Treatment Period">
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <div class="form-group position-relative mb-3">
                                                                        <label class="form-label">Contact Number</label>
                                                                        <input type="text" class="form-control" id="foodname" aria-describedby="foodname" placeholder="Contact Number">
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <div class="form-group position-relative mb-3">
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="form-group position-relative mb-3">
                                                                        ...
                                                                        <input type="text" class="form-control" id="foodname" aria-describedby="foodname" placeholder="Address">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="user-details-footer">
                                                ...
                                                <div class="payment-paid-div">
                                                    ...
                                                    <a href="{{url('user-credit-card-pay')}}" class="payment-pay-btn fsb-1 text-dark">
                                                        Pay Now
                                                    </a>
                                                </div>
