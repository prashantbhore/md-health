...
<div class="container df-center sign-in-form" style="height: 100vh;" id="logDiv">
            ...
            <div class="d-flex flex-column align-items-center gap-3">
                ...
                <div class="w-100 df-center">
                    ...
                    <form id="loginForm">
                        ...
                        <div class="pt-100px">
                            <button class="btn cont-btn w-100 mb-4 df-center waves-effect waves-light" type="button" id="signup">Continue</button>
                        </div>
                        <div class="text-center">
                            <a href="{{ url('/') }}" class="btn-text text-decoration-underline text-black">Back to MDhealth.co</a>
                        </div>
