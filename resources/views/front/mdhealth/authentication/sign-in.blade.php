                ...
                <div class="w-100 df-center">
                    ...
                    <form id="loginForm">
                        ...
                        <div class="text-center">
                            <a href="{{ url('/') }}" class="btn-text text-black text-decoration-underline">Back to MDhealth.co</a>
                        </div>
    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="d-flex align-items-center justify-content-center mt-3">
                <button class="btn cont-btn w-75 mb-4 df-center" id="verifyBtn" type="button" onclick="verify()" style="height: 47px;">Sign
                    In</button>
            </div>
            </form>
            <script>
