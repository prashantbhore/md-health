    ...
    <div class="container text-center my-5 authentication">
        ...
        <div class="tab-content" id="myTabContent">
            <div class="login-form">
                <div class="row pt-4">
                    <div class="col-md-5 bod-right pt-4  mb-5">
                        ...
                        <div class="col-md-12">
                            <div class="mb-3 hide-eye-div">
                                ...
                                <input type="password" class="form-control" name="repassword" id="repassword" placeholder="Minimum 8 characters">
                        ...
                        <div class="col-md-12 text-center d-flex flex-column gap-3">
                            <button class="btn btn-md w-100" type="button" id="medproreg" style="height: 47px;">Create
                                Account</button>
