                                        ...
                                        <div class="row gy-3">
                                            ...
                                            {{-- <div class="row"> --}}
                                                <div class="col-md-12">
                                                    ...
                                                    <input type="text" class="form-control " readonly name="countrycode"
                                                        id="countrycode" />
                                                </div>
                                                <div class="col-md-12">
                                            ...
                                            <div class="col-md-12">
                                                <div class="tc" style="width: 330px;line-height: 2;">
                                                    <div class="form-check">
                                                        ...
                                                        <input class="form-check-input d-inline-block me-2"
                                                            type="checkbox" value="" id="UserflexCheckDefault"
