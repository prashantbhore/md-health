                                        ...
                                        <div class="row gy-3">
                                            ...
                                            <div class="col-md-12 position-relative">
                                                <div class="tc" style="width: 330px;line-height: 2;">
                                                    ...
                                                    <input class="form-check-input d-inline-block me-2" type="checkbox"
                                                        value="" id="UserflexCheckDefault"
                                                        name="UserflexCheckDefault" />
                                                    <label class="form-check-label d-inline" for="UserflexCheckDefault">
                                                        ...
                                                        & I agree to the
                                                        <a href="#"
                                                            class="text-decoration-underline camptonBold">User Data
                                                            Consent.</a>
                                                    </label>
                                                    <!-- </div> -->
                                                </div>
