...
<div class="position-relative">
    <div class="content-wrapper" id="regdiv">
        <div class="container text-center my-4 authentication pt-3">
            <div class="w-100 position-relative" style="margin-bottom:1.5rem;">
                            ...
                            <div class="form text-start">
                                <form id="mycustomerForm">
                                    ...
                                    <div class="row gy-3">
                                        ...
                                        <!-- 
                                        <div class="col-md-3">
                                            <label for="countrycode" class="form-label">&nbsp;</label>
                                            <input type="text" class="form-control " readonly name="countrycode" id="countrycode" />
                                        </div> -->
                                        ...
                                        <div class="col-md-12 position-relative">
                                            ...
                                            <div class="input-group ">
                                                ...
                                                <input type="text" class="form-control" name="phoneno" id="phoneno" placeholder="Phone" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12 position-relative">
                                            <div class="tc" style="width: 330px;line-height: 2;">
                                                ...
                                                <label class="form-check-label d-inline" for="UserflexCheckDefault">
                                                    I accept
                                                    <a href="#" class="text-decoration-underline camptonBold">Terms and Condition</a>
                                                    & I agree to the
                                                    <a href="#" class="text-decoration-underline camptonBold">User Data Consent.</a>
                                                </label>
                                                <!-- </div> -->
                                            </div>
                                        </div>
