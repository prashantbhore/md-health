                                ...
                                <form id="mycustomerForm">
                                    ...
                                    <div class="row gy-3">
                                        ...
                                        <div class="col-md-12 position-relative">
                                            <div class="tc" style="width: 330px;line-height: 2;">
                                                ...
                                                <label class="form-check-label d-inline" for="UserflexCheckDefault">
                                                    I accept
                                                    <a href="#" class="text-decoration-underline camptonBold">Terms and
                                                        Condition</a>
                                                    & I agree to the
                                                    <a href="#" class="text-decoration-underline camptonBold">User Data
                                                        Consent.</a>
                                                </label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12 text-center d-flex flex-column gap-3 py-100px">
                                            <button type="button" class="btn cont-btn w-100 df-center" style="margin-bottom: 3.6rem;" id="regcustuser">Create
                                                Account</button>
