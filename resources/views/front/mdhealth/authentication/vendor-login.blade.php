                                ...
                                <div class="row gx-5 gy-2">
                                    ...
                                    <div class="col-md-12 mb-3">
                                        <div class="hide-eye-div">
                                            ...
                                            <input type="password" class="form-control w-407p5" name="password" id="password" placeholder="Minimum 8 characters" />
                                    ...
                                    <div class="col-md-12 mb-3">
                                        <div class="hide-eye-div">
                                            ...
                                            <input type="password" class="form-control w-407p5" name="repassword" id="repassword" placeholder="Minimum 8 characters" />
