    ...
    <div class="searchBar backBtn bg-f6">
                        ...
                        <div class="col-md-3 ">
                            <div class="df-end">
                                <div class="d-flex align-items-start flex-column">
                                    ...
                                    <h5 class="card-h4 mt-0">1.490,00 <span class="lira">₺</span> <span class="card-h1">*(398,90 <span class="lira">₺</span> ) </span></h5>
                                </div>
                            </div>
                        </div>
                        <!-- PRICE BOX NAME END -->
        ...
        <div class="mb-4 discount-sctn">
            ...
            <div class="d-flex justify-content-between mb-3">
                ...
                <p class="mb-0 t_price">Total Price <span class="total_price" style="color: #000;">34.560,00 ₺</span></p>
            </div>
            ...
            <div class="row">
                <div class="col-5 card-details me-5">
                    ...
                    <form id="procced_to_pay_form" action="{{ url('/sandbox') }}" method="POST">
                        ...
                        <div class="mb-3">
                            <input type="number" name="input2" class="form-control" id="input2" placeholder="Card Number">
                        </div>
                        <div class="d-flex gap-2 mb-4">
                            <input type="password" id="input3" name="input3" class="form-control w-50" placeholder="CVV">
                            <input type="text" id="input4" name="input4" class="form-control w-50" placeholder="Valid Till">
                        </div>
                        <!-- <a href="{{ url('payment-status') }}"> -->
                        <!-- <a href="{{ url('payment-status') }}" -->
                        <a href="javascript:void(0)" style="color: #fff; height: unset; padding: 12px 2rem;" class="btn purchaseBtn" style="color: #fff;">Proceed Payment</a>
                        <!-- </a> -->
                    </form>
                </div>
                <div class="col-5">
