    ...
    <div class="searchBar backBtn bg-f6">
        <div class="container pt-4">
            ...
            <div class="d-flex flex-column align-items-center mb-5">
                ...
                <p class="underline smallFont fw-normal campton"><u>Payment</u></p>
            </div>


            <div class="paymentSection" style="padding-bottom: 65px;">
                <div class="row">
                    <div class="col-2">
            ...
            <div id="card">
                <div class="d-flex">
                    <div class="card-details w-50 pt-3">
                        ...
                        <form id="procced_to_pay_form" action="{{ url('/sandbox') }}" method="POST">
                            ...
                            <div class="mb-4">
                                ...
                                <h5 id="verifyinput1" class="my-0" style="color: red;">
                            ...
                            <div class="mb-4">
                                ...
                                <h5 id="verifyinput2" class="my-0" style="color: red;">
                                    Please Enter Card Number
                                </h5>
                            </div>
                            <div class="d-flex gap-3 mb-0">
                                <input type="text" id="input4" name="input4" class="form-control mb-0 w-226" placeholder="00/00">
                                <input type="password" id="input3" name="input3" class="form-control mb-0 w-226" placeholder="CVV">

                            </div>
                            <div class="d-flex gap-3 mb-4">

                                <h5 id="verifyinput4" class="my-0 " style="color: red;">
                                    Please Enter Expiry Date
                                </h5>
                                <h5 id="verifyinput3" class="my-0 " style="color: red;">
                                    Please Enter CVV
                                </h5>
                            </div>
                            <!-- <a href="{{ url('payment-status') }}"> -->
                            <!-- <a href="{{ url('payment-status') }}" -->
                            <a href="javascript:void(0)" class="btn purchaseBtn w-226 df-center" style="color: #fff;">Proceed Payment</a>
                            <!-- </a> -->
                        </form>
                    </div>
