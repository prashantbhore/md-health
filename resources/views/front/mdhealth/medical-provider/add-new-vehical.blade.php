                                    ...
                                    <div class="input-group mb-4">
                                        <div class="form-group d-flex flex-column w-100">
                                            ...
                                            <input type="text" class="form-control"
                                                placeholder="Enter Vehicle Model Name" name="vehicle_model_name"
                                                id="vehicle_model_name"
                                                value="{{ !empty($transportation_details['vehicle_model_name']) ? $transportation_details['vehicle_model_name'] : '' }}">
                                    ...
                                    <div class="form-group mb-5 position-relative">
                                        ...
                                        <div class="form-group mb-3">
                                            <input type="file" name="vehicle_image_path" id="vehicle_image_path"
                                                placeholder="Vehicle Picture" class="form-control text-dark"
                                        ...
                                        <div class="prev-img-div">
                                            <img src="{{ !empty($transportation_details['vehicle_image_path']) ? $transportation_details['vehicle_image_path'] : 'front/assets/img/uploadHere.png' }}"
                                                alt="image" id="pic">
                                            <input type="hidden" name="old_image" id="old_image"
                                                value="{{ !empty($transportation_details['vehicle_image_path']) ? $transportation_details['vehicle_image_path'] : '' }}">
                                        </div>
                                        <div class="form-group mb-3">
                                            <label class="form-label fst-italic fsb-2">*Please make sure the photo have
                                    ...
                                    <div class="form-group mb-4 section-heading-div">
                                        ...
                                        <div class="input-icon-div">
                                            <input type="text" class="form-control" placeholder="0"
                                                name="vehicle_per_day_price" id="vehicle_per_day_price"
                                                value="{{ !empty($transportation_details['vehicle_per_day_price']) ? $transportation_details['vehicle_per_day_price'] : '' }}">
                                        ...
                                        <div class="form-group d-flex flex-column">
                                            ...
                                            <div class="multiple-checks">
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" value="No Smoking"
                                                        id="fornosmoking"
                                                        {{ !empty($transportation_details['other_services']) && strpos($transportation_details['other_services'], 'No Smoking') !== false ? 'checked' : '' }}>
                                                ...
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" value="Wi-Fi"
                                                        id="forwifi"
                                                        {{ !empty($transportation_details['other_services']) && strpos($transportation_details['other_services'], 'Wi-Fi') !== false ? 'checked' : '' }}>
