                        ...
                        <div class="card-body">
                            ...
                            <div class="tab-div medical-sales-tab">
                                ...
                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" id="sale-inprogress-tab" data-bs-toggle="tab"
                                            data-bs-target="#sale-inprogress" type="button" role="tab"
                                            aria-controls="sale-inprogress" aria-selected="true">Completed</button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                ...
                                <div class="tab-content" id="myTabContent">
                                                        ...
                                                        <div class="col-md-6 justify-content-start ps-0">
                                                            <div class="trmt-card-body">
                                                                <h5 class="dashboard-card-title">Treatment No:
                                                                    ...
                                                                    <span
                                                                        class="{{ !empty($activeSale['purchase_type']) ? ($activeSale['purchase_type'] == 'pending' ? 'pending' : 'in-progress') : '' }}">
                                    ...
                                    <div class="tab-pane fade" id="sale-inprogress" role="tabpanel"
                                        aria-labelledby="sale-inprogress-tab">
                                                        ...
                                                        <div class="col-md-6 justify-content-start ps-0">
                                                            <div class="trmt-card-body">
                                                                <h5 class="dashboard-card-title">Treatment
                                                                    No:{{ !empty($completedSale['order_id']) ? $completedSale['order_id'] : '' }}<span
                                                                        class="active">{{ !empty($completedSale['purchase_type']) ? ucfirst($completedSale['purchase_type']) : '' }}</span>
                                                                </h5>
                                                                <h5 class="mb-0 fw-500">
                                                    ...
                                                    <div class="row card-row align-items-center">
                                                        ...
                                                        <div class="col-md-6 justify-content-start ps-0">
                                                            <div class="trmt-card-body">
                                                                <h5 class="dashboard-card-title">Treatment
                                                                    No:{{ !empty($completedSale['order_id']) ? $completedSale['order_id'] : '' }}<span
                                                                        class="cancel">{{ !empty($completedSale['purchase_type']) ? ucfirst($completedSale['purchase_type']) : '' }}</span>
                                                                </h5>
                                                                <h5 class="mb-0 fw-500">
                                                                    {{ !empty($completedSale['customer']['full_name']) ? $completedSale['customer']['full_name'] : '' }}
                                                                </h5>
