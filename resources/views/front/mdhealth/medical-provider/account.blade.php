            ...
            <div class="d-flex gap-3">
                ...
                <div class="w-761">
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <div class="form-div">
                                <form action="{{ url('md-update-medical-profile') }}" method="post"
                                    enctype="multipart/form-data" id="accountmedpro" class="from-prevent-multiple-submits">
                                    @csrf
                                            ...
                                            <select name="country_id" id="country_id" class="form-select">
                                                @foreach ($countries as $country)
                                                    <option value="{{ $country->id }}"
                                                        {{ $country->id == $medical_provider_list->country_id ? 'selected' : '' }}>
                                            ...
                                            <select name="city_id" id="city_id" class="form-select">
                                                @foreach ($cities as $city)
                                                    <option value="{{ $city->id }}"
                                                        {{ $city->id == $medical_provider_list->city_id ? 'selected' : '' }}>
                                                        {{ $city->city_name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="form-group mb-4">
                                        <label class="form-label mb-3">Company Overview</label>
                                        <textarea class="form-control summernote summernote-1" name="company_overview" id="company_overview" rows="4"
                                            style="height: 150px;" placeholder="Company Overview" data-gramm="false" wt-ignore-input="true">{{ $medical_provider_list->company_overview }}</textarea>
                                    </div>
