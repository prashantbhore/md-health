        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="mb-5">
                            <h6 class="section-heading section-btns justify-content-between align-items-center">Acommodition
                                <a href="{{url('add-acommodition')}}" class="green-plate bg-dark text-green fw-500 fs-6">Add New Acommodition</a>
                            </h6>
                                ...
                                <div class="row card-row align-items-center">
                                    ...
                                    <div class="col-md-6 justify-content-start ps-0">
                                        <div class="trmt-card-body">
                                            <h5 class="dashboard-card-title">Renaissence Hotel Istanbul</h5>
                        ...
                        <div class="mb-5">
                            <h6 class="section-heading section-btns justify-content-between align-items-center">Transportation
                                <a href="{{url('add-new-vehical')}}" class="green-plate bg-dark text-green fw-500 fs-6">Add New Vehicle</a>
                            </h6>
                            <div class="treatment-card df-start w-100 mb-3">
                                <div class="row card-row align-items-center">
                                    <div class="col-md-2 df-center px-0">
                        ...
                        <div class="mb-5">
                            <h6 class="section-heading section-btns justify-content-between align-items-center">Tour
                                <a href="{{url('add-tour')}}" class="green-plate bg-dark text-green fw-500 fs-6">Add Tour</a>
                            </h6>
                            <div class="treatment-card df-start w-100 mb-3">
                                <div class="row card-row align-items-center">
                                    <div class="col-md-2 df-center px-0">
                                    ...
                                    <div class="col-md-6 justify-content-start ps-0">
                                        <div class="trmt-card-body">
                                            <h5 class="dashboard-card-title">Lorem ipsum dolor sit amet.</h5>
                                            <span class="active">Active</span>
                                        </div>
                                    </div>
                                    <div class="col-md-4 d-flex flex-column justify-content-between align-items-end text-end">
                            ...
                            <div class="treatment-card df-start w-100 mb-3">
                                <div class="row card-row align-items-center">
                                    ...
                                    <div class="col-md-6 justify-content-start ps-0">
                                        <div class="trmt-card-body">
                                            <h5 class="dashboard-card-title">Lorem ipsum dolor sit amet.</h5>
                                            <span class="cancel">Deactivate</span>
                                        </div>
                                    </div>
                                    <div class="col-md-4 d-flex flex-column justify-content-between align-items-end text-end">
                                        <div class="trmt-card-footer icon-btns">
