                                        ...
                                        <div class="treatment-card df-start w-100 mb-5" id="div_{{ $hotel_detail['id'] }}">
                                            <div class="row card-row align-items-center">
                                                <div class="col-md-2 df-center px-0">
                                                    <img src="{{ $hotel_detail['hotel_image_path'] }}" alt=""
                                                        width="100px">
                                                </div>
                                                <div class="col-md-6 justify-content-start ps-0">
                                                    <div class="trmt-card-body">
                                                        <h5 class="dashboard-card-title">{{ $hotel_detail['hotel_name'] }}
                                                        </h5>
                                                        <a href="#"
                                                        ...
                                                        <span onclick="vehicle_delete('{{ $vehicle_detail['id'] }}')"
                                                            ...
                                                            <svg width="20" height="19" viewBox="0 0 20 19"
                                                                ...
                                                                <path
                                                                    ...
                                                                    stroke="#F24E1E" stroke-width="0.875"
                    ...
                    @if (!empty($tour_details))
                        @foreach ($tour_details as $tour_detail)
                            <div class="treatment-card df-start w-100 mb-3" id="divtr_{{ $tour_detail['id'] }}">
                                <div class="row card-row align-items-center">
                                    <div class="col-md-2 df-center px-0">
                                        <img src="{{ !empty($tour_detail['tour_image_path']) ? $tour_detail['tour_image_path'] : 'front/assets/img/Memorial.svg' }}"
                                            alt="" width="100px">
                                    </div>
                                    <div class="col-md-6 justify-content-start ps-0">
                                        <div class="trmt-card-body">
                                            <h5 class="dashboard-card-title">{{ $tour_detail['tour_name'] }}
                                            </h5>
                                            @if ($tour_detail['status'] == 'active')
                                                <a href="#" class="btn-active">{{ $tour_detail['status'] }}</a>
                                            @else
                                                <a href="#" class="btn-active"
                                                    style="background-color:black;">{{ $tour_detail['status'] }}</a>
                                            @endif
                                    ...
                                    <div
                                        class="col-md-4 d-flex flex-column justify-content-between align-items-end text-end">
                                        <div class="trmt-card-footer icon-btns">
                                            <a href="{{ url('edit-tour/' . Crypt::encrypt($tour_detail['id'])) }}"
                                                class="mt-auto view-detail-btn">
                                                <svg width="19" height="19" viewBox="0 0 19 19" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <path fill-rule="evenodd" clip-rule="evenodd"
...
@section('script')
    ...
    @endsection@extends('front.layout.layout2')
@section('content')
    <style>
        .section-heading.section-btns a {
            width: 35%;
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <div>
                                ...
                                @if (!empty($hotel_details))
                                    @foreach ($hotel_details as $hotel_detail)
                                        <div class="treatment-card df-start w-100 mb-5"
                                            id="div_{{ $hotel_detail['id'] }}">
                                            <div class="row card-row align-items-center">
                                                <div class="col-md-2 df-center px-0">
                                                    <img src="{{ $hotel_detail['hotel_image_path'] }}" alt=""
                                                        width="100px">
