                ...
                <div class="col-md-9">
                    <div class="card mb-4">
                        <h5 class="card-header d-flex justify-content-between mb-2">
                            ...
                            <div>
                                <a href="{{ url('medical-provider-dashboard') }}"
                            ...
                            <div class="tab-div treatment-dashboard-tab">
                                ...
                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                    <li class="nav-item " role="presentation">
                                        <button class=" nav-link active btn btn-md btn-text" id="patient-details-tab"
                                            data-bs-toggle="tab" data-bs-target="#patient-details" type="button"
                                            role="tab" aria-controls="patient-details" aria-selected="true">Patient
                                            Details</button>
                                    </li>
                                    <li class="nav-item " role="presentation">
                                        <button class=" nav-link btn btn-md btn-text" id="patient-package-details-tab"
                                    ...
                                    <li class="  nav-item" role="presentation">
                                        <button class="btn btn-md btn-text nav-link" id="patient-message-tab"
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17"
                                                ...
                                                <path
                                                    d="M7 7.875H14M7 11.375H10.0625M9.1875 17.0625L7.875 15.75H5.25C4.55381 15.75 3.88613 15.4734 3.39384 14.9812C2.90156 14.4889 2.625 13.8212 2.625 13.125V6.125C2.625 5.42881 2.90156 4.76113 3.39384 4.26884C3.88613 3.77656 4.55381 3.5 5.25 3.5H15.75C16.4462 3.5 17.1139 3.77656 17.6062 4.26884C18.0984 4.76113 18.375 5.42881 18.375 6.125V9.625"
                                                    stroke="#111111" stroke-width="1.16667" stroke-linecap="round"
                                                    stroke-linejoin="round" />
                                                <path
                                                    d="M15.7501 19.2497L18.6814 16.3762C18.8611 16.2017 19.0041 15.9931 19.1019 15.7625C19.1996 15.5319 19.2502 15.284 19.2506 15.0335C19.251 14.7831 19.2013 14.535 19.1042 14.3041C19.0072 14.0732 18.8649 13.8641 18.6857 13.689C18.3201 13.3315 17.8293 13.1308 17.3179 13.1298C16.8064 13.1288 16.3149 13.3276 15.9479 13.6838L15.7519 13.8763L15.5567 13.6838C15.1911 13.3265 14.7005 13.126 14.1893 13.125C13.6781 13.124 13.1867 13.3226 12.8197 13.6785C12.6399 13.8529 12.4969 14.0615 12.399 14.2921C12.3012 14.5227 12.2505 14.7705 12.25 15.021C12.2495 15.2715 12.2992 15.5195 12.3962 15.7505C12.4931 15.9814 12.6354 16.1906 12.8145 16.3657L15.7501 19.2497Z"
                                                    stroke="#111111" stroke-width="1.16667" stroke-linecap="round"
                                                    stroke-linejoin="round" />
                                            </svg>
                                            Message</button>
                                        ...
                                        <div class="py-3">
                                            <div class="row card-details">
                                                ...
                                                <form method="POST" action="{{ route('status.date.store') }}">
                                                    ...
                                                    <input type="hidden" name="treatment_purchage_id"
                                                        value="{{ !empty($patient_details['id']) ? $patient_details['id'] : '' }}">
                                                    <div class="col-md-12 mb-4">
                                                        ...
                                                        <div>
                                                            ...
                                                            <input type="text" id="datepicker" class="form-control"
                                                                ...
                                                                value="{{ !empty($patient_details['treatment_start_date']) ? $patient_details['treatment_start_date'] : '' }}" />
                                                    ...
                                                    <div class="col-md-12 mb-3">
                                                        <div class="form-group d-flex flex-column">
                                                            ...
                                                            <select name="treatment_status" id=""
                                                                class="form-control cstom-select-img">
                                                                <option value="pending"
                                                                    {{ !empty($patient_details['purchase_type']) && $patient_details['purchase_type'] == 'pending' ? 'selected' : '' }}>
                                                                    Pending</option>
                                                                <option value="in_progress"
                                                                    {{ !empty($patient_details['purchase_type']) && $patient_details['purchase_type'] == 'in_progress' ? 'selected' : '' }}>
                                                                    In Progress</option>
                                                                <option value="completed"
                                                                    {{ !empty($patient_details['purchase_type']) && $patient_details['purchase_type'] == 'completed' ? 'selected' : '' }}>
                                                                    Complete</option>
                                                                <option value="cancelled"
                                                                    {{ !empty($patient_details['purchase_type']) && $patient_details['purchase_type'] == 'cancelled' ? 'selected' : '' }}>
                                                                    Cancel</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="section-btns pt-2">
                                                            <button type="submit"
                                                                class="black-plate text-light w-100 btn fsb-1"
                                                                style="background-color: #000002;">Save Changes</button>
                                                        </div>
                                                    </div>
                                                </form>
                                    ...
                                    <div class="tab-pane fade" id="patient-package-details" role="tabpanel"
                                        ...
                                        <div class="py-3">
                                            ...
                                            <form method="POST" action="{{ route('assign.case.manager') }}">
                                                ...
                                                @csrf
                                                <input type="hidden" name="purchage_id"
                                                    value="{{ !empty($patient_details['id']) ? $patient_details['id'] : '' }}">
                                                ...
                                                <div class="col-md-12 mb-3 payment-div">
                                                    ...
                                                    <div class="example-div">
                                                        ...
                                                        <p class="mb-0"><b>Case No <span
                                                                    class="text-green">#{{ !empty($patient_details['case_no']) ? $patient_details['case_no'] : '' }}</span>
                                                        </p>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-12 mb-3 payment-div">
                                                    ...
                                                    <div class="example-div">
                                                        <p class="mb-1">
                                                            ...
                                                            <span
                                                                class="text-green">{{ !empty($patient_details['hotel']['hotel_address']) ? $patient_details['hotel']['hotel_address'] : '' }}</span>
                                                        </p>
                                                        <div class="for-icon-text">
                                                            <p
                                                                class="mb-1 fst-italic fw-500 d-flex align-items-center gap-2">
                                                                <svg width="16" height="14" viewBox="0 0 16 17"
                                                                    fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                    <path
                                                        ...
                                                        <div class="for-icon-text">
                                                            <p
                                                                class="mb-1 fst-italic fw-500 d-flex align-items-center gap-2">
                                                                <svg width="10" height="14" viewBox="0 0 10 15"
                                                                    fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                    <path
                                                ...
                                                <div class="col-md-12 mb-3">
                                                    ...
                                                    <div class="example-div">
                                                        <p class="mb-2"><span class="fw-800">Vehicle:</span> <span
                                                                class="fw-500">{{ !empty($patient_details['vehical']['vehicle_model_id']) ? $patient_details['vehical']['vehicle_model_id'] : '' }}</span>
                                                        </p>
                                                        <div class="for-icon-text d-flex gap-4">
                                                            ...
                                                            <p class="mb-1 fw-500 d-flex align-items-center gap-2">
                                                                <svg width="20" height="20" viewBox="0 0 20 20"
                                                                    fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                    <path
                                                                        d="M7.50016 15.8329H12.5002V17.4996H7.50016C5.20016 17.4996 3.3335 15.6329 3.3335 13.3329V5.83294H5.00016V13.3329C5.00016 14.7163 6.11683 15.8329 7.50016 15.8329ZM8.6835 4.50794C9.3335 3.85794 9.3335 2.79961 8.6835 2.14961C8.0335 1.49961 6.97516 1.49961 6.32516 2.14961C5.67516 2.79961 5.67516 3.85794 6.32516 4.50794C6.97516 5.16628 8.02516 5.16628 8.6835 4.50794ZM9.5835 7.49961C9.5835 6.58294 8.8335 5.83294 7.91683 5.83294H7.50016C6.5835 5.83294 5.8335 6.58294 5.8335 7.49961V12.4996C5.8335 13.8829 6.95016 14.9996 8.3335 14.9996H12.5585L15.4752 17.9163L16.6668 16.7246L12.4418 12.4996H9.5835V7.49961Z"
                                                                        fill="#111111" />
                                                                </svg>
                                                                7+1
                                                            </p>
                                                            ...
                                                            <p class="mb-1 fw-500 d-flex align-items-center gap-2">
                                                                <svg width="20" height="20" viewBox="0 0 20 20"
                                                                    ...
                                                                    <path
                                                                        ...
                                                                        stroke="#111111" stroke-width="1.66667"
                                                ...
                                                <div class="col-md-12">
                                                    <div class="section-btns pt-2">
                                                        <button type="submit"
                                                            class="green-plate bg-dark text-white fw-700 w-100">Save
                                                            Changes</button>
                                                    </div>
                                                </div>
                                            </form>
