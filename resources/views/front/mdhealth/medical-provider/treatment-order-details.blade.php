                    ...
                    <div class="card-body">
                        <div class="tab-div treatment-dashboard-tab">
                            ...
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                ...
                                <li class="nav-item " role="presentation">
                                    <button class=" nav-link btn btn-md btn-text" id="patient-package-details-tab" data-bs-toggle="tab" data-bs-target="#patient-package-details" type="button" role="tab" aria-controls="patient-package-details" aria-selected="true">In Progress</button>
                                </li>
                                <li class="  nav-item" role="presentation">
                                    <button class="btn btn-md btn-text nav-link" id="patient-message-tab" data-bs-toggle="tab" data-bs-target="#patient-message" role="tab" aria-controls="patient-message" aria-selected="true">
                                            ...
                                            <div class="col-md-6 mb-3 align-self-end">
                                                <div class="request-btn-div">
                                                    ...
                                                    <div class="section-btns pt-2 justify-content-end">
                                                        <a href="javascript:void(0);" class="green-plate bg-green text-dark fw-700 w-75 fsb-1">Request Payment</a>
                                                    </div>
                                                </div>
                                            </div>
