...
<style>
    ...
    .treatment-dashboard-tab .nav-link.active, .treatment-dashboard-tab .nav-link:hover {
        border-bottom: 0;
                        ...
                        <div class="tab-div treatment-dashboard-tab">
                            ...
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                <li class="nav-item " role="presentation">
                                    <button class=" nav-link active btn btn-md btn-text" id="patient-details-tab" data-bs-toggle="tab" data-bs-target="#patient-details" type="button"
                                        role="tab" aria-controls="patient-details" aria-selected="true">Patient Details</button>
                                </li>
                                <li class="nav-item " role="presentation">
                                    <button class=" nav-link btn btn-md btn-text" id="patient-package-details-tab" data-bs-toggle="tab" data-bs-target="#patient-package-details" type="button"
                                        role="tab" aria-controls="patient-package-details" aria-selected="true">In Progress</button>
                                </li>
                                <li class="  nav-item" role="presentation">
                                    <button class="btn btn-md btn-text nav-link" id="patient-message-tab" data-bs-toggle="tab"
                                            ...
                                            <div class="col-md-12 mb-3">
                                                <div class="payment-div mb-4">
                                                    ...
                                                    <h6 class="fsb-2 mb-0 fst-italic d-flex align-items-center gap-1">
                                                        ...
                                                        12 December 2023 - 19 December 2023</h6>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-12 mb-3 payment-div">
                                                    ...
                                                    <div class="example-div">
                                                        ...
                                                        <div class="for-icon-text">
                                                            ...
                                                            Distance to hospital <span class="fw-800">3.7 KM</span></p>
                                                        </div>
                                                    </div>
                                                </div>
