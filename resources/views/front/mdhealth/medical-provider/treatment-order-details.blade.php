...
<style>
    ...
    .example-div {
        border-bottom: 2px solid #A6ED82;
        padding-bottom: 4rem;
        margin-bottom: 4rem;
    }
    ...
    #patient-package-details .form-select {
        background-position: right;
    }
</style>
                                ...
                                <div class="tab-pane fade" id="patient-package-details" role="tabpanel" aria-labelledby="patient-package-details-tab">
                                    <div class="py-3">
                                        ...
                                        <div class="col-md-12 mb-5">
                                            <div class="payment-div mb-4">
                                                <h6 class="card-h4 mb-3">Treatment Details</h6>
                                                <h6 class="card-h3">{{ !empty($patient_details['package']['package_name']) ? $patient_details['package']['package_name'] : '' }}
                                                </h6>
                                                <h6 class=" mb-0 fst-italic d-flex align-items-center gap-1 card-h3 camLight">
                                        ...
                                        <form method="POST" action="{{ route('assign.case.manager') }}">
                                            ...
                                            <!-- CASE DETAILS -->
                                            <div class="col-md-12 mb-5 payment-div">
                                                <h6 class="card-h4 mb-3">Case Details</h6>
                                                <h6 class="card-h1 camptonBook">Assign Case Manager</h6>

                                                <div class="input-with-cross mb-3">
                                                    <select class="form-select" name="case_manager_id" id="" aria-describedby="">
                                                ...
                                                <div class="example-div">
                                                    <p class="card-h3 mb-0"><b>Case Manager:</b>{{ !empty($patient_details['case_manager']['name']) ? $patient_details['case_manager']['name'] : '' }}</p>
                                                    <p class="card-h3 mb-0"><b>Case No <span class="text-green"> {{ !empty($patient_details['case_no']) ? $patient_details['case_no'] : '' }}</span>
                                                    </p>
                                                </div>
                                            </div>
                                            <!-- END -->
                                            ...
                                            <div class="col-md-12 mb-3 payment-div">
                                                <h6 class="card-h4 mb-3">Accommodation Details</h6>
                                                {{-- <h6>Assign Hotel</h6> --}}
                                                {{-- <div class="input-with-cross mb-3">
                                                ...
                                                <div class="form-group d-flex flex-column mb-2">
                                                    <h6 class="card-h1 camptonBook">Assign Hotel</h6>
                                                    <select name="vehicle_id" id="" class="cstom-select-img form-select">
                                                ...
                                                <div class="example-div">
                                                    <div class="mb-1">
                                                        <h6 class="card-h1 d-inline-block mb-2">Hotel: <span class="card-h3 camptonBook">{{ !empty($patient_details['hotel']['hotel_name']) ? $patient_details['hotel']['hotel_name'] : '' }}</span></h6>
                                                        <span class="text-green card-h3">{{ !empty($patient_details['hotel']['hotel_address']) ? $patient_details['hotel']['hotel_address'] : '' }}</span>
                                                    </div>

                                                    <div class="for-icon-text">
                                                        <p class="mb-1 d-flex gap-2 fst-italic card-h3 camLight">
                                                    ...
                                                    <div class="for-icon-text">
                                                        <p class="mb-1 d-flex gap-2 fst-italic card-h3 camLight">
                                                            <svg width="16" height="14" viewBox="0 0 10 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <div class="col-md-12 mb-3">
                                                <h6 class="card-h4 mb-3">Transportation Details</h6>
                                                <div class="form-group d-flex flex-column mb-2">
                                                    <h6 class="card-h1 camptonBook">Assign Vehicle</h6>
                                                    <select name="vehicle_id" id="" class="cstom-select-img form-select">
                                                ...
                                                <div class="example-div">
                                                    ...
                                                    <div class="for-icon-text d-flex align-items-center gap-4">
                                                        ...
                                                        <p class="mb-1 d-flex gap-2 fst-italic card-h3 camLight">
                                                            <svg width="20" height="16" viewBox="0 0 15 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        ...
                                                        <p class="mb-1 d-flex gap-2 fst-italic card-h3 camLight">
                                                            <svg width="20" height="12" viewBox="0 0 16 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <div class="col-md-12 mb-3">
                                                <div class="form-group d-flex flex-column mb-2">
                                                    <h6 class="card-h4 mb-3">Status</h6>
                                                    <select name="purchase_type" id="" class="cstom-select-img form-select">
                                                        <option value="pending" {{ !empty($patient_details['purchase_type']) && $patient_details['purchase_type'] == 'pending' ? 'selected' : '' }}>
                                                            Pending</option>
                                                        <option value="in_progress" {{ !empty($patient_details['purchase_type']) && $patient_details['purchase_type'] == 'in_progress' ? 'selected' : '' }}>
                                                            In Progress</option>
                                            ...
                                            <div class="col-md-12">
                                                <div class="section-btns pt-2">
                                                    <button type="submit" class="btn save-btn-black green-plate w-100">Save Changes</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
