                                    ...
                                    <div class="row card-row align-items-center">
                                        ...
                                        <div class="col-md-6 justify-content-start ps-0">
                                            <div class="trmt-card-body">
                                                <h5 class="card-h1">With: Acibadem Hospital</h5>
                                                <h5 class="mb-0 fw-500">
                                                    ...
                                                    </svg> Conversation Date: <b>About To Start</b>
                                                </h5>
                                            </div>
                                        </div>
                                        <div class="col-md-4 d-flex flex-column justify-content-between align-items-end text-end">
                                            <div class="trmt-card-footer d-flex flex-column gap-1">
                                                <a href="{{url('live-cam')}}" class="active">Go Live</a>
                                                <span class="cancel">Cancel Live Consultation</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
