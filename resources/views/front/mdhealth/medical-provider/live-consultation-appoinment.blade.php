...
<style>
    ...
    .trmt-card-footer span.cancel, .trmt-card-footer span.active{
        width: 165px;
        padding: 5px 20px;
    }
</style>
                        ...
                        <div class="message-div d-flex justify-content-between flex-column w-100 ">
                            <div class="message-header">
                                <h5 class="d-flex align-items-center justify-content-between bg-light fw-700 p-4 mb-3 fsb-1">
                                    <span><svg class="me-2" width="25" height="25" viewBox="0 0 18 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    Live Consultation Appointments</span>
                                    ...
                                    <div class="row card-row align-items-center">
                                        ...
                                        <div class="col-md-6 justify-content-start ps-0">
                                            <div class="trmt-card-body">
                                                <h5 class="dashboard-card-title">With: Acibadem Hospital</h5>
                                        ...
                                        <div class="col-md-4 d-flex flex-column justify-content-between align-items-end text-end">
                                            <div class="trmt-card-footer d-flex flex-column gap-1">
                                                <span class="active">Go Live</span>
