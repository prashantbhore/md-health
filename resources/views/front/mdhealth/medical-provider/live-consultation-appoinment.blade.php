                    ...
                    <div class="card-body d-flex" style="min-height:800px">
                        <div class="message-div d-flex justify-content-between flex-column w-100 ">
                            <div class="message-header">
                                <h5 class="d-flex align-items-center justify-content-between bg-light fw-700 p-4 mb-3 fsb-1 card-h1">
                                    <div>
                                        <svg class="me-2" width="25" height="25" viewBox="0 0 18 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div class="d-flex w-100 gap-3">
                                        ...
                                        <div class="">
                                            <div class="trmt-card-body">
                                                <h5 class="card-h1 mb-3">With: Acibadem Hospital</h5>
