                        ...
                        <div class="form-div">
                            ...
                            <form action="{{ url('md-add-tour') }}" method="post" enctype="multipart/form-data" id="add_acommodition">
                                ...
                                <div class="multiple-checkbox-div mb-5">
                                    <div class="form-group d-flex flex-column">
                                        ...
                                        <div class="multiple-checks">
                                            ...
                                            <div class="form-check">
                                                <input type="checkbox" value="No Smoking" class="form-check-input" id="fornosmoking" {{ !empty($tour_details['tour_other_services']) && strpos($tour_details['tour_other_services'], 'No Smoking') !== false ? 'checked' : '' }}>
                                            ...
                                            <div class="form-check">
                                                <input type="checkbox" value="Wi-Fi" class="form-check-input" id="forwifi" {{ !empty($tour_details['tour_other_services']) && strpos($tour_details['tour_other_services'], 'Wi-Fi') !== false ? 'checked' : '' }}>
                                            ...
                                            <div class="form-check">
                                                <input type="checkbox" value="Fitness Center" class="form-check-input" id="forfitness" {{ !empty($tour_details['tour_other_services']) && strpos($tour_details['tour_other_services'], 'Fitness Center') !== false ? 'checked' : '' }}>
                                ...
                                <div class="section-btns mb-4 d-flex gap-3">
                                    <button type="submit" name="button_type" value="active" class="btn save-btn-black bg-green text-black w-50">Save Tour</button>
