                        ...
                        <div class="form-div">
                            ...
                            {{-- @endif --}}
                                ...
                                <div class="section-btns mb-4 d-flex gap-2">
                                    <button type="submit" name="button_type" value="active" class="green-plate bg-green text-dark fw-600 fsb-1">Save Tour</button>
                                    <button type="submit" name="button_type"  value="inactive" class="black-plate bg-black text-white fw-500 fsb-1">Deactive Tour</button>
                                </div>
