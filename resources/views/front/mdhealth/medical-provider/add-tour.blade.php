                            ...
                            <div class="form-div">
                                ...
                                <form action="{{ url('md-add-tour') }}" method="post" enctype="multipart/form-data"
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <textarea class="form-control" id="tour_description" name="tour_description" rows="3"
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <div class="prev-img-div">
                                            <img src="{{ !empty($tour_details['tour_image_path']) ? $tour_details['tour_image_path'] : 'front/assets/img/default-img.png' }}"
                                                alt="image" id="pic" />
