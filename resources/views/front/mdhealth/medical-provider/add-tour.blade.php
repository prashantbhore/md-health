                        ...
                        <div class="form-div">
                            <form>
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control" id="foodname" aria-describedby="foodname" placeholder="Please Write Here">
                                </div>
                                    ...
                                    <div class="form-group d-flex flex-column">
                                        ...
                                        <div class="multiple-checks">
                                            <div class="form-check">
                                                <input type="checkbox" class="form-check-input" id="fordinner">
                                            ...
                                            <div class="form-check">
                                                <input type="checkbox" class="form-check-input" id="forspa">
                                            ...
                                            <div class="form-check">
                                                <input type="checkbox" class="form-check-input" id="forfitness">
                                ...
                                <div class="section-btns mb-4 d-flex gap-2">
                                    <a href="javascript:void(0);" class="green-plate bg-green text-dark fw-600 fsb-1">Save Tour</a>
                                    <a href="javascript:void(0);" class="black-plate bg-black text-white fw-500 fsb-1">Deactive Tour</a>
                                </div>
