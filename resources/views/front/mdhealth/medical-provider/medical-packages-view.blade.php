            ...
            <div class="d-flex gap-3">
                ...
                <div class="w-761">
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <div class="form-div">
                                <form action="{{ url('/md-add-packages') }}" method="post" id="package_add" class="from-prevent-multiple-submits">
                                    @csrf
                                    ...
                                    <div id="visaserviceDiv">
                                        <div class="form-group mb-3 section-heading-div">
                                            ...
                                            <label class="form-label my-3" for="featureproducts">Please Written Visa
                                                Service
                                                Details</label>
                                    ...
                                    <div id="ambulanceserviceDiv">
                                        <div class="form-group d-flex flex-column mb-5 section-heading-div">
                                            ...
                                            <label class="form-label mb-3">Ambulance Price (One Time Pickup and Drop)
                                            </label>
                                            <div class="input-icon-div">
...
{{-- {{dd(intval($packages_active_list['package_discount']))}} --}}
                                    ...
                                    <div class="form-group d-flex flex-column mb-5 section-heading-div">
                                        ...
                                        <div class="form-check">
                                            <input type="checkbox" class="form-check-input" name="featured_product"
                                                id="featured_product"
                                        ...
                                        <div class="form-check">
                                            <label class="form-check-label" style="line-height: 1.65;" for="featureproducts">I confirm that all
                                                details are correct and meets the <a href="#"
                                                    ...
                                                    Conditions.</a></label>
                                            <input type="checkbox" class="form-check-input" name="featureproducts"
                                                id="featureproducts"
