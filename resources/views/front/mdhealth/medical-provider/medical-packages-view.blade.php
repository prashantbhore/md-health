            ...
            <div class="col-md-9">
                <div class="card mb-4">
                    ...
                    <div class="section-btns mb-5">
                        <a href="javascript:void(0);" class="green-plate bg-green text-dark fw-700 fsb-1">Total Accomodition
                ...
                <div id="transportationDiv">
                    ...
                    <div class="section-btns mb-5">
                        <a href="javascript:void(0);" class="green-plate bg-green text-dark fw-700 fsb-1">Total Transportation
                ...
                <div id="tourDiv">
                    ...
                    <div class="section-btns mb-5">
                        <a href="javascript:void(0);" class="green-plate bg-green text-dark fw-700 fsb-1">Total Tour Price
                ...
                <div class="form-group d-flex flex-column mb-5 section-heading-div">
                    ...
                    <div class="form-check">
                        ...
                        <label class="form-check-label tc-text" for="featureproducts">I confirm
                            that all details are correct and meets the <a href="#" class="text-green fw-700">Terms & Conditions.</a></label>
                    </div>
                </div>
                <input type="hidden" name="platform_type" value="web">
                <div class="section-btns mb-3 df-center gap-3">
                    <button type="submit" name="button_type" value="active" class="btn save-btn-black w-50 bg-green text-black">Save Changes</button>
