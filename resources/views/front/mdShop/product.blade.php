                    ...
                    <div class="col-4">
                        <div class="product-img-view">
                            <div style="--swiper-navigation-color: #fff; --swiper-pagination-color: #fff"
                                class="mb-5 swiper myProductsSwiper">
                        ...
                        <div class="product-content">
                            <div class="product-content-header">
                                <div class="product-name mb-2">
                                    ...
                                    <span
                                        class="text-green">{{ !empty($product_data['product_category_name']) ? $product_data['product_category_name'] : '' }}</span>
                                </div>
                                ...
                                <h3 class="product-price">
                                    {{ !empty($product_data['sale_price']) ? $product_data['sale_price'] : '' }} ₺ </h3>
                            </div>
                            ...
                            <div class="product-content-div">
                                ...
                                <p>{{ !empty($product_data['product_descrition']) ? $product_data['product_descrition'] : '' }}
                                </p>
                            </div>
                    ...
                    <div class="col-3">
                        <div class="right-side-div">
                            <div class="product-request">
                                ...
                                <div
                                    class="product-div2 mb-4 {{ !empty($product_data['free_shipping']) && $product_data['free_shipping'] == 'no' ? 'd-none' : '' }}">
                                    <svg width="28" height="28" viewBox="0 0 13 13" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                                            d="M5.97404 1.37575C6.13494 1.28639 6.31595 1.2395 6.5 1.2395C6.68405 1.2395 6.86506 1.28639 7.02596 1.37575L11.0966 3.63666C11.181 3.68359 11.2513 3.75223 11.3002 3.83547C11.3492 3.9187 11.375 4.01351 11.375 4.11008V8.5707C11.375 8.76389 11.3233 8.95354 11.2253 9.12002C11.1272 9.2865 10.9865 9.42375 10.8176 9.51754L7.02596 11.6246C6.86506 11.714 6.68405 11.7609 6.5 11.7609C6.31595 11.7609 6.13494 11.714 5.97404 11.6246L2.18237 9.51754C2.01357 9.42379 1.87288 9.28663 1.77489 9.12026C1.67689 8.95388 1.62514 8.76434 1.625 8.57125V4.11008C1.625 4.01351 1.65081 3.9187 1.69976 3.83547C1.74871 3.75223 1.81902 3.68359 1.90342 3.63666L5.97404 1.37575Z"
                                            stroke="#4CDB06" stroke-linecap="round" stroke-linejoin="round" />
                                        <path d="M4.0625 2.4375L8.9375 5.14583V7.04167M3.25 6.67767L4.875 7.58333"
                                            stroke="#4CDB06" stroke-linecap="round" stroke-linejoin="round" />
                                        <path d="M1.625 3.7915L6.5 6.49984M6.5 6.49984L11.375 3.7915M6.5 6.49984V11.9165"
                                            stroke="#4CDB06" stroke-linejoin="round" />
                                    </svg>
                    ...
                    <div class="reviews mt-4">
                        ...
                        <div class="review mb-4">
                            <div class="mb-4">
                                ...
                                <p class="d-inline camptonBook">Lorem ipsum dolor sit, amet consectetur adipisicing elit.
                                    Dignissimos beatae quia vero eaque officia, aperiam quas accusantium neque non ducimus
                                    explicabo eligendi. Cupiditate sit recusandae tempora quia velit, asperiores odio.</p>
                            </div>
                            <div class="mb-4">
                                <p class="mb-1 fs-6 camptonBold">Ali G. / <span class="fst-italic camptonBook">Heart Valve
                ...
                <div class="modal-body d-flex align-items-end border-top">
                    <div>
                        <div class="d-flex gap-3">
                            ...
                            <div>
                                <h5 class="card-h1 mb-0 camptonBook">
                                    {{ !empty($product_data['product_name']) ? $product_data['product_name'] : '' }}</h5>
                                <p class="card-h4 text-green d-inline-block">1x</p>
                                <p class="card-h4 d-inline-block">
                                    {{ !empty($product_data['sale_price']) ? $product_data['sale_price'] : '' }}<span
                                        class="lira">₺</span></p>
                            </div>
                        </div>
                        <div class="border-0 df-center justify-content-between gap-3">
                            <button type="button" class="btn bg-green card-h1" style="width: 149px;height:32px">Go to
                                Cart</button>
                            <button type="button" class="btn bg-black card-h1 text-light camptonBook"
                                style="width: 149px;height:32px" data-bs-dismiss="modal">Close</button>
                        </div>
                    </div>
                </div>
            </div>
