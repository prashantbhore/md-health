...
@section('content')
    <div class="content-wrapper paymentsPage mdShop">
        <!-- SECTION 1 -->
        <div class="searchBar backBtn bg-f6" style="padding-top: 0;">
            <div class="container pt-4">
                <div class="d-flex flex-column align-items-center gap-4 py-5">
                        ...
                        <p class="vSmallFont camptonBook fw-bold">You can go to the "<span class="camptonBold"><u>Orders</u></span>" page or to the <span class="camptonBold"><u>Homepage</u></span> to see your reservations.</p>
                </div>
            </div>
        </div>
