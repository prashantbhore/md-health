...
<div class="content-wrapper bg-f6">
    ...
    <div class="searchBar bg-f6">
        <div class="container pt-4">
            <a href="home-service" class="backBtn d-flex align-items-center mb-5 gap-2">
            ...
            <div id="buyService" class="packageResult rounded mb-3" style="display: block;">
                <div>
                    <div class="d-flex align-items-center justify-content-between" style="width: 50%">
                        ...
                        <img src="{{('front/assets/img/verifiedBy.svg')}}" alt="" class="me-5">
                    </div>
                    ...
                    <div class="d-flex gap-4">
                        ...
                        <div class="d-flex flex-grow-1 gap-4">
                            <div class="d-flex justify-content-between flex-grow-1">
                                ...
                                <div class="d-flex gap-2 mb-2 align-self-end">
