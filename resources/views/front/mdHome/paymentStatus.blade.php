        ...
        <div class="searchBar backBtn bg-f6">
            <div class="container pt-4">
                <div class="d-flex flex-column align-items-center gap-4 py-5">
                    ...
                    <p class="vSmallFont camptonBook fw-bold">You can go to the "<span class="camptonBold"
                            id="go_to_packages"><u>packages</u></span>" page or to the <span class="camptonBold"
                            id="home_page"><u>Homepage</u></span> to see your reservations.</p>
                </div>
            </div>
        </div>
