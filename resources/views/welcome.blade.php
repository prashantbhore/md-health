...
<script src="https://www.gstatic.com/firebasejs/6.0.2/firebase.js"></script>
    ...
    function resendCode() {
        ...
        try {
            var newRecaptchaVerifier = new firebase.auth.RecaptchaVerifier(containerId);

            firebase.auth().signInWithPhoneNumber(number, newRecaptchaVerifier)
...
alert(number);
                    ...
                    // Update the confirmation result to the new value
