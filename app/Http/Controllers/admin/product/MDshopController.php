...
class MDshopController extends Controller
{
    public function  index(){
      ...
      $md_home_service_category_count = ProductCategory::where('status', 'active')->where('main_product_category_id', 4)->count();
        return view('admin.products-and-categories.categories.mdshop',compact('md_health_category_count','md_shop_category_count','md_food_category_count','md_home_service_category_count'));
      }
    ...
    //   }
    //   }
    //  return redirect('admin/category-mdshop')->with('success', 'MDshop Category added successfully!');
    ...
    public function store(Request $request){
      ...
      if (!empty($request->id)){
          ...
          if ($existingCategory) {
              ...
              return redirect('admin/category-mdshop')->with('success', 'MDshop Category updated successfully!');
          } else {
    ...
    public function data_table(Request $request)
    {
        ...
        ->where('main_product_category_id', 2)
        ->with('subcategories')
